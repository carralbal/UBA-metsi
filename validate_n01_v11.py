...
SOURCE = HERE / "N01" / "source" / "N01_metodologia_sin_recetas-v11.md"
CURATION = HERE / "N01" / "image-curation" / "image-manifest.json"
ROOT = HERE / "N01-v11-final"
HTML = ROOT / "index.html"
CSS = ROOT / "magazine.css"
DIAGRAM = ROOT / "diagrams" / "N01-mapa-decision.svg"
PDF = ROOT / "output" / "N01-METSI-lectura-previa-v11-final.pdf"
...
def page_occupancies(pdf: Path) -> list[float]:
    ...
    with tempfile.TemporaryDirectory(prefix="n01-v11-occupancy-") as folder:
...
def main() -> None:
    ...
    checks = [
        check("v8_v9_and_v10_baselines_frozen", baseline_frozen, frozen_paths),
