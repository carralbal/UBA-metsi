...
¿Cómo elegir la forma de realizar una capacidad sin reducir todo a construir o comprar ni trasladar riesgos invisibles a proveedores, operación o personas?
...
## Hotel Horizonte: decidir qué configurar, integrar, construir o no automatizar
...
## Movimiento 1 · Separar la capacidad del artefacto que la realiza
...
## Movimiento 2 · Comparar configurar, integrar, construir y no automatizar
...
Oscar Varsavsky obliga a incorporar una pregunta anterior a la comparación técnica: qué estilo de desarrollo y qué proyecto de organización vuelve deseable una alternativa. Una tecnología no es neutral por ser eficiente ni apropiada por estar disponible. Selecciona dependencias, distribuye capacidades y favorece ciertos problemas, escalas y actores. En HH-19, comprar, construir o integrar no sólo cambia costo y velocidad. Cambia quién puede modificar una regla, qué conocimiento se forma localmente, qué evidencia controla el proveedor y qué opciones futuras conserva el hotel.

Esta perspectiva no exige producir todo internamente. Exige declarar la racionalidad de selección y confrontarla con alternativas. Una solución importada puede ser adecuada si sus contratos, capacidades y condiciones de salida sostienen la promesa. Una construcción propia puede ser inadecuada si concentra saber y consume recursos que el servicio necesita. El expediente agrega propósito, autonomía requerida y dependencia aceptable para que la decisión tecnológica no quede reducida a prestaciones y precio.

La selección incluye una estrategia de aprendizaje. Si dos alternativas cumplen hoy, puede preferirse la que permita comprender antes la incertidumbre decisiva y conservar opciones. Esa ventaja debe expresarse como una prueba y un umbral de continuidad, no como una promesa general de soberanía.
...
## Movimiento 3 · Gobernar dependencia, transición y salida
...
### Instrumento HH-19: expediente de opciones de realización
...
1. **Capacidad y resultado.** Formular qué posibilidad sostenida debe existir y qué cambio observable justificará la inversión.

2. **Frontera diferenciadora.** Precisar qué parte exige control propio y qué parte puede resolverse con una capacidad común del mercado.

3. **Opciones consideradas.** Incluir configurar, integrar, construir, contratar, sostener manualmente y no automatizar, sin convertir la opción preferida en única candidata.

4. **Supuestos.** Registrar volumen, variabilidad, disponibilidad, competencias y restricciones cuya modificación alteraría la comparación.

5. **Costo total.** Comparar adquisición, integración, operación, cambio, seguridad, soporte, salida y reparación durante el ciclo de vida.

6. **Tiempo para aprender.** Estimar cuándo cada opción puede producir evidencia útil sobre adecuación, uso e impacto, no sólo cuándo puede demostrarse.

7. **Control y autoridad.** Identificar quién puede cambiar reglas, acceder a evidencia, detener servicio y responder por decisiones de terceros.

8. **Dependencias.** Examinar contratos, formatos, datos, capacidades internas y calendarios que condicionan adopción o salida.

9. **Seguridad y suministro.** Trazar componentes y servicios externos, sus actualizaciones, vulnerabilidades, garantías y responsables de respuesta.

10. **Operación y reparación.** Comprobar quién monitorea, atiende excepciones, recupera el servicio y repara consecuencias para las personas afectadas.

11. **Portabilidad.** Probar exportación, significado, configuración y continuidad operacional en un destino alternativo, con tiempo y costo medidos.

12. **Prueba y salida.** Diseñar una prueba comparable, umbrales de decisión y una ruta practicable para abandonar la opción sin perder evidencia ni servicio.
...
### Caso de transferencia: plataforma universitaria de alertas
...
### Contraejemplo: construir para evitar dependencia y depender de tres personas
...
### Comparar precio y omitir ciclo de vida
...
### Llamar estándar a toda práctica del proveedor
...
### Integrar sin contratos semánticos
...
### Construir sin capacidad de operar
...
### Automatizar una excepción rara
...
### Aceptar portabilidad sin probarla
...
1. Una demostración sólo resulta comparable después de formular la capacidad, el episodio adverso y la evidencia de salida.

2. Toda alternativa debe incluir el sistema de trabajo que la vuelve operable, no sólo el artefacto visible o su precio inicial.

3. Configurar reduce construcción propia, pero conserva decisiones sobre reglas, pruebas, actualizaciones y responsabilidad.

4. Una interfaz conectada no demuestra integración mientras significado, tiempos, fallas y reparación permanezcan abiertos.

5. Tercerizar distribuye actividades y responsabilidades; no elimina la rendición de cuentas ni las obligaciones no delegables.
...
1. ¿Qué capacidad se necesita y qué cambia si el análisis comienza por un producto disponible?

2. ¿Por qué operar manualmente o no automatizar pueden ser alternativas profesionales y no ausencia de solución?

3. ¿Qué frontera separa una configuración sostenible de una personalización que crea dependencia oculta?

4. ¿Qué contratos semánticos y operacionales deberían probarse antes de aceptar una integración?

5. ¿Qué diferenciación o restricción justificaría construir y asumir el ciclo de vida completo?

6. ¿Qué prueba demostraría portabilidad real y cómo se distinguen ejecución delegada, responsabilidad asignada, rendición de cuentas y obligación no delegable?
...
**Ronald Coase.** Explicó por qué las fronteras de la organización dependen de costos de coordinación.

**Oliver Williamson.** Desarrolló el análisis de gobernanza y costos de transacción.

**Thomas Davenport.** Vinculó procesos, información, tecnología y cambio organizacional.

**Tim Berners-Lee.** Impulsó estándares abiertos e interoperables que reducen dependencia de una implementación particular.

**Murugiah Souppaya.** Codificó prácticas de desarrollo seguro que pueden convertirse en evidencia exigible a productos y proveedores.

**Elham Tabassi.** Lideró un marco para gobernar y medir riesgos de inteligencia artificial durante adquisición, uso y retiro.

## Referencias base

- Coase, R. H. (1937). “The Nature of the Firm”. *Economica*, 4(16), 386-405. https://doi.org/10.1111/j.1468-0335.1937.tb00002.x
- Williamson, O. E. (1985). *The Economic Institutions of Capitalism*. Free Press.
- Baldwin, C. Y. y Clark, K. B. (2000). *Design Rules*. MIT Press.
...
- NIST (2022). *Software Security in Supply Chains*. https://www.nist.gov/itl/executive-order-14028-improving-nations-cybersecurity/software-security-supply-chains
- CISA (2024). *Software Acquisition Guide for Government Enterprise Consumers: Software Assurance in the Cyber-Supply Chain Risk Management Lifecycle*. https://www.cisa.gov/sites/default/files/2024-07/PDM24050%20Software%20Acquisition%20Guide%20for%20Government%20Enterprise%20ConsumersV2_508c.pdf
- NTIA (2021). *Software Bill of Materials*. https://www.ntia.gov/page/software-bill-materials
- ISO/IEC (2023). *ISO/IEC 27036-3:2023 Cybersecurity, Supplier relationships, Part 3: Guidelines for hardware, software, and services supply chain security*. https://www.iso.org/standard/82890.html
