...
## La regla que nadie encontraba y todos obedecían
...
## Hotel Horizonte: la regla heredada que todavía protege
...
Federico Müller reúne configuración del PMS, permisos de cerraduras, registros de llamadas, el reclamo que originó la práctica y las condiciones del canal de venta. Camila Duarte aporta la promesa publicada, Ricardo Sosa identifica quién repara cuando los estados divergen y Mariela aporta testimonio operacional sobre las condiciones que vuelven utilizable una habitación. Esas evidencias demuestran un compromiso institucional y comercial de no reasignar una habitación accesible ya prometida. No constituyen una fuente normativa ni demuestran por sí solas si existe una obligación legal adicional. HH-18 abre un registro separado y considera identificada una fuente normativa sólo cuando una autoridad competente consigna el instrumento, la disposición aplicable, su vigencia, su ámbito y quién puede interpretarla. Hasta completar esa validación, el fundamento jurídico permanece explícitamente pendiente.
...
## Movimiento 1 · Leer el legado como capacidad y evidencia
...
## Movimiento 2 · Traducir obligaciones sin fingir una única implementación
...
## Movimiento 3 · Cambiar con trazabilidad, contingencia y retiro
...
### Instrumento HH-18: expediente de obligación y legado
...
1. **Elemento heredado.** Identificar componente, regla, dato, práctica o acuerdo y localizar dónde interviene en el episodio estudiado.

2. **Capacidad que sostiene.** Describir qué trabajo permite realizar hoy, para quién y bajo qué condiciones, antes de clasificarlo como deuda.

3. **Decisión de origen.** Reconstruir qué problema resolvía, qué alternativas existían y qué supuestos hicieron razonable conservarlo.

4. **Obligación vigente.** Citar la norma, contrato, derecho o política aplicable y distinguir el mandato de una interpretación interna modificable.

5. **Dependencias.** Mapear sistemas, proveedores, personas y calendarios que podrían ampliar el radio de impacto de un cambio.

6. **Evidencia disponible.** Inventariar registros, código, contratos, incidentes y observaciones, indicando procedencia, fecha y vacíos conocidos.

7. **Personas que conocen.** Nombrar quién opera, repara e interpreta el legado y qué conocimiento crítico todavía permanece tácito.

8. **Riesgo de cambio.** Estimar fallas, pérdida semántica, interrupción y daños distributivos posibles durante la transición.

9. **Riesgo de conservar.** Examinar exposición, obsolescencia, dependencia y trabajo manual acumulado si el elemento permanece sin cambios.

10. **Documentación mínima.** Definir qué decisiones, significados, excepciones y procedimientos necesita otra persona para sostener o modificar la capacidad.

11. **Transición y contingencia.** Explicitar convivencia de versiones, reconciliación de datos, reversión y respuesta cuando la migración no preserve el servicio.

12. **Prueba y condición de retiro.** Establecer cómo se comprobará equivalencia o mejora y qué evidencia autorizará retirar el elemento y su conocimiento asociado.
...
### Caso de transferencia: expediente clínico que cambia de plataforma
...
### Contraejemplo: documentar cada pantalla y perder la decisión
...
### Tratar todo lo viejo como deuda
...
### Conservar por miedo sin registrar valor
...
### Traducir normas en casillas aisladas
...
### Documentar la interfaz y omitir decisiones
...
### Migrar registros sin preservar significado
...
### Formalizar excepciones antes de evaluarlas
...
### Depender de una persona como control
...
### Actualizar componentes sin prueba de impacto
...
### Usar IA como autoridad arqueológica
...
### Retirar sin conservar memoria suficiente
...
1. Antes de retirar una pieza heredada debe demostrarse qué capacidad sostiene y cómo continuará sin depender de memoria personal.

2. La ausencia de documentación aumenta incertidumbre; no demuestra que una regla carezca de función, vigencia o autoridad.

3. La deuda puede ser deliberada, accidental o emergente; siempre exige hacer visible qué costo o riesgo futuro impone el estado actual.

4. El acoplamiento se prueba mediante cambios y fallas controladas, no contando únicamente conexiones técnicas.

5. Ningún requisito debe presentarse como normativo sin fuente, ámbito y autoridad interpretativa explícitos.
...
1. ¿Qué capacidad actual se perdería si se reemplazara el componente más antiguo del episodio?

2. ¿Qué fuentes permitirían reconstruir por qué existe una excepción y quién puede interpretar su origen?

3. ¿Qué costo o riesgo futuro impone el estado actual, cómo se originó y quién lo absorbe hoy?

4. ¿Cómo se probaría el radio de impacto de un cambio sin confiar sólo en documentación declarativa?

5. ¿Qué evidencia permite distinguir un compromiso institucional, una obligación normativa validada y una protección de diseño, y quién puede interpretar cada fuente?

6. ¿Qué evidencia autorizaría retirar un elemento heredado sin perder significado, trazabilidad ni capacidad de reparación?
...
**Manny Lehman.** Estudió la evolución continua de sistemas usados en entornos reales.

**David Parnas.** Mostró el valor de ocultar decisiones y diseñar para el cambio.

**Martin Fowler.** Sistematizó la refactorización como cambio incremental, observable y protegido por pruebas.

**Murugiah Souppaya.** Codificó prácticas de desarrollo seguro y su adaptación a sistemas con inteligencia artificial.

**Karen Scarfone.** Contribuyó a integrar riesgo, procedencia y seguridad dentro del ciclo de desarrollo.

**Tim Berners-Lee.** Impulsó estándares abiertos e interoperables que permiten separar información, identificación y plataforma.
...
- ISO/IEC/IEEE (2019). *ISO/IEC/IEEE 15289:2019 Systems and software engineering — Content of life-cycle information items (documentation)*. https://www.iso.org/standard/74909.html
...
- Argentina (2000). *Ley 25.326 de Protección de los Datos Personales*. https://www.argentina.gob.ar/normativa/nacional/ley-25326-64790/texto
...
- Booth, H., Souppaya, M., Vassilev, A., Ogata, M., Stanley, M. y Scarfone, K. (2024). *Secure Software Development Practices for Generative AI and Dual-Use Foundation Models: An SSDF Community Profile*. NIST SP 800-218A. https://doi.org/10.6028/NIST.SP.800-218A
