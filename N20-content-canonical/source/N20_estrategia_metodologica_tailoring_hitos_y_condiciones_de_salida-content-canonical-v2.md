...
## El proyecto que tenía todas las prácticas y ninguna salida

Hotel Horizonte reúne todo lo aprendido: evidencia, actores, procesos, estados, modelos, contradicciones, legado y opciones de realización. La conducción arma una estrategia con descubrimiento, iteraciones, arquitectura, comité, piloto, tablero, retrospectivas y auditoría. Ninguna práctica parece incorrecta.

A los cuatro meses, todas siguen activas. El descubrimiento produce nuevos hallazgos sin cerrar preguntas. Las iteraciones entregan configuraciones que el piloto no absorbe. El comité revisa informes y nunca detiene. La auditoría solicita evidencia que nadie vinculó con decisiones. La abundancia metodológica creó trabajo sin arquitectura de compromiso.
...
El nuevo mapa revela incompatibilidades. La cadencia de iteración exige decisiones semanales, pero el comité regulatorio se reúne una vez por mes. El piloto necesita datos que la migración sólo producirá al final. La auditoría pide trazas que la configuración actual no genera. Ninguna práctica individual era absurda; su composición producía esperas, duplicación y evidencias tardías. La estrategia debe alinear ritmos y dependencias, no sumar actividades correctas.

Se separan cuatro tramos. Comprender termina cuando los episodios y obligaciones permiten formular una hipótesis. Preparar termina cuando datos, personas y contingencia hacen legítimo exponer. Probar termina con evidencia suficiente para decidir ampliación. Transferir termina cuando operación sostiene y repara sin asistencia extraordinaria. Cada tramo tiene una opción de detener y un conjunto limitado de prácticas.

La primera puerta decide cerrar una línea de investigación que no cambia ninguna opción. Otra puerta retrasa el anuncio comercial porque aún no existe reversión. La conducción descubre que gobernar también significa renunciar. Liberar capacidad y preservar una alternativa puede ser más valioso que mantener todos los frentes activos por temor a reconocer incertidumbre.
...
3. **Factores situacionales.** Registrar criticidad, novedad, regulación, distribución, tamaño, competencias y reversibilidad que condicionan el tailoring.
...
### Usar tailoring para ocultar pérdida de rigor
