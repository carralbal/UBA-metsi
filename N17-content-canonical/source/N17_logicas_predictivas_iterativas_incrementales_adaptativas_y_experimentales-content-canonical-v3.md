...
El equipo distingue incertidumbre técnica, de necesidad, de adopción y de contexto. Cada una modifica qué conviene decidir y cuándo. Scrum puede ofrecer una cadencia de inspección y adaptación; Kanban puede hacer visible flujo, límites y espera; PMBOK puede ayudar a gobernar dominios y compromisos. Ninguno responde por sí solo qué combinación resulta pertinente ni convierte una etiqueta metodológica en estrategia.
...
Comparar enfoques exige comenzar por su función. La Guía del PMBOK, octava edición, organiza un estándar profesional para dirigir proyectos mediante seis principios, siete dominios de desempeño y orientación de procesos que debe adaptarse al contexto. Scrum define un marco de trabajo ligero para producir valor frente a problemas complejos mediante un equipo, eventos, artefactos y compromisos. La Guía Kanban define una estrategia para optimizar flujo a partir de una definición explícita del trabajo, la gestión activa de sus elementos y la mejora del sistema. Predicción, iteración, incremento, adaptación y experimentación, en cambio, son lógicas para relacionar conocimiento, compromiso y aprendizaje. No compiten en un único catálogo.

La diferencia evita asociaciones automáticas. Un proyecto puede gobernarse con principios y dominios de PMBOK y emplear Scrum en una parte del trabajo. Un equipo Scrum puede utilizar Kanban para observar flujo sin que el sprint deje de ser su contenedor formal. Un sistema Kanban puede operar sin sprints. Cualquiera de estas configuraciones puede incluir decisiones predictivas, incrementales o experimentales. Decir que una organización trabaja con PMBOK, Scrum o Kanban todavía no explica qué lógica aplica a cada incertidumbre ni qué evidencia gobierna sus compromisos.

PMBOK aporta una vista amplia de valor, gobernanza, alcance, cronograma, finanzas, interesados, recursos y riesgo. Su octava edición conserva la base de principios y dominios de la séptima, la simplifica en seis principios y siete dominios e incorpora orientación de procesos no prescriptiva. Esa arquitectura no obliga a ejecutar cuarenta procesos como secuencia uniforme. Permite seleccionar prácticas y relacionarlas con la entrega de valor, pero exige justificar el ajuste. En Hotel Horizonte resulta útil para la migración del PMS, porque deben coordinarse presupuesto, proveedor, ventanas, riesgo, adquisiciones y responsabilidades que exceden el trabajo de un solo equipo.

Scrum aporta empirismo y una cadencia integrada de inspección y adaptación. El Objetivo de Producto orienta una trayectoria, el Objetivo del Sprint concentra un compromiso y la Definición de Terminado establece una condición compartida de calidad para el Incremento. El marco no promete que todo problema se vuelva claro al dividirlo en sprints. Tampoco define por sí solo arquitectura, investigación, operación, presupuesto o gobierno institucional. En el hotel puede organizar el trabajo del equipo que mejora la llegada, siempre que el incremento represente una capacidad utilizable y que la revisión incluya a quienes sostienen y reciben el servicio.

Kanban aporta una lente continua sobre el flujo. Obliga a definir qué unidad atraviesa el sistema, dónde comienza y termina, qué estados la transforman, qué trabajo se controla y qué métricas permiten mejorarlo. No prescribe roles ni una iteración temporal fija. En Hotel Horizonte puede mostrar que una solicitud accesible espera cuatro días antes de ser aceptada, aunque el desarrollo la complete dentro de un sprint. También puede revelar que el límite local del equipo desplaza inventario a correos, aprobaciones o consultas de Recepción. Su evidencia corrige una lectura encerrada en ceremonias.
...
### Acelerar cadencia sin autoridad disponible
...
### Tratar reversibilidad como simple reversión técnica
...
- Kurtz, C. F. y Snowden, D. J. (2003). “The New Dynamics of Strategy: Sense-making in a Complex and Complicated World”. *IBM Systems Journal*, 42(3), 462–483. https://doi.org/10.1147/sj.423.0462
