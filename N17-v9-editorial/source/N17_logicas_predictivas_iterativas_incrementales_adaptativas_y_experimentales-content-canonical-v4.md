...
¿Cómo elegir una forma de trabajo cuando algunas decisiones pueden anticiparse, otras exigen aprender y no todos los errores tienen el mismo costo?

## El plan cumplió todas sus fechas y llegó tarde al problema

Una provincia contrata un sistema para otorgar turnos de vacunación. El plan fija nueve meses, alcance, presupuesto, proveedor y una secuencia de relevamiento, configuración, pruebas y despliegue. Cada hito se cumple. La plataforma entra en producción el día previsto y distribuye turnos según residencia, edad y disponibilidad informada por los centros.

Durante la implementación cambia la campaña sanitaria, aparecen puntos móviles y aumenta la demanda de personas que no pueden usar el canal digital. El proyecto conserva el alcance aprobado porque modificar reglas comprometería contratos, migración y fecha pública. La solución entrega exactamente lo acordado y organiza con mayor velocidad una población que ya no representa el problema vigente.

La explicación fácil culpa al enfoque predictivo. Sin embargo, varias decisiones sí requerían anticipación: compras, protección de datos, capacidad de frío, capacitación y continuidad operativa. Otras necesitaban ciclos diferentes. La experiencia de inscripción podía iterarse con personas; la cobertura territorial podía crecer por incrementos; las reglas de prioridad debían adaptarse a nueva evidencia; el punto móvil requería un experimento limitado antes de prometer escala.

El equipo distingue cuatro dudas diferentes. Puede no saber si la tecnología funcionará, si comprendió la necesidad, si las personas adoptarán la solución o si el contexto permanecerá estable. Cada duda cambia qué conviene decidir y cuándo. Scrum puede ofrecer un ritmo de revisión; Kanban puede mostrar el flujo, los límites y las esperas; PMBOK puede ayudar a gobernar compromisos. Ninguno decide por sí solo qué combinación conviene.

Surgen dos posiciones rivales. Una propone replanificar todo y detener el despliegue. Otra defiende cumplir primero y adaptar después. Ambas trasladan el mismo criterio a toda la intervención. El equipo conserva compromisos irreversibles y reabre los revisables: mantiene infraestructura y acuerdos de datos, prueba reglas en una población acotada, entrega cobertura por zonas y compara un canal asistido con el autoservicio.

Cada tramo produce evidencia para el siguiente. El prototipo puede debilitar una interpretación; el incremento demuestra integración; el experimento estima un mecanismo; la planificación protege obligaciones conocidas. Las puertas de decisión establecen qué debe saberse para ampliar, detener o cambiar de lógica. La estrategia ya no se nombra por una marca global, sino por la relación entre incertidumbre, consecuencia, reversibilidad y aprendizaje.

La comparación se vuelve examinable porque cada lógica conserva un criterio propio de avance. Cumplir un plan prueba coordinación respecto de supuestos declarados; completar una iteración muestra qué cambió al confrontar una representación; liberar un incremento demuestra capacidad parcial en uso; adaptar exige una señal que justifique revisar; experimentar requiere una hipótesis que pueda debilitarse. Sin esa distinción, cualquier actividad puede presentarse como aprendizaje y cualquier demora como prudencia.

N17 abre el Bloque D con esa disciplina. Recibe de N16 una cartera de modelos y contradicciones gobernadas. Su tarea no es elegir entre predictivo o ágil como identidades, sino componer lógicas de intervención capaces de anticipar donde corresponde, aprender donde hace falta y conservar decisiones revisables sin ocultar compromisos reales.

## Hotel Horizonte: cinco lógicas para una misma intervención
...
El argumento combina ideas que cumplen funciones distintas. El riesgo y el ciclo de vida ayudan a graduar compromisos. El empirismo y la agilidad organizan el aprendizaje. La reflexión y la complejidad muestran que una intervención también cambia el problema que intenta resolver. El gobierno y los estándares ayudan a fijar autoridad, evidencia y condiciones de salida. Ninguna fuente decide por sí sola qué lógica corresponde a un episodio.
...
## Movimiento 1 · Separar lógicas antes de combinarlas
...
Esa localización evita un error frecuente: buscar una metodología que absorba todas las dudas bajo una misma etiqueta. Si la incertidumbre está en la demanda futura, hacen falta escenarios y rangos. Si está en el significado compartido de un estado, se necesitan episodios contrastados y acuerdos semánticos. Si concierne al efecto de una intervención, corresponde formular hipótesis rivales y observar consecuencias.

La evidencia que reduce una clase de incertidumbre puede no reducir otra. Un prototipo puede aclarar la comprensión sin demostrar solidez operacional. Una prueba de carga puede demostrar capacidad técnica sin decir nada sobre la justicia de una regla.

La distinción también tiene una consecuencia distributiva. Cuanto más general es la frase “todavía no sabemos”, mayor es la posibilidad de exponer a quienes tienen menos capacidad de reclamar para aprender algo que podría haberse averiguado de otro modo.

Antes de decidir una prueba, HH-17 pregunta quién carga con el costo de la duda, quién recibe el beneficio esperado y qué parte puede resolverse mediante análisis, simulación o consulta. Sólo la duda restante justifica una exposición, que debe ser proporcional y reparable.
...
Un plan para la ventana de migración puede incluir rangos de ocupación, capacidad de reserva y contingencias. También necesita fijar quién estará disponible y qué servicios no pueden interrumpirse. La calidad predictiva se observa en la claridad de los supuestos, no en la apariencia exacta del calendario.

El mecanismo central es el compromiso coordinado. Varias personas pueden preparar recursos, permisos y secuencias porque comparten una idea de lo que ocurrirá y de qué hará cada una si un supuesto falla. Por eso una predicción útil incluye comprobaciones anteriores al daño.

Si el proveedor no entrega el entorno de prueba o la ocupación supera el rango previsto, la respuesta ya está decidida: postergar la migración, reducir el alcance o activar otra ventana. La contingencia forma parte del plan. No es una admisión tardía de fracaso.
...
En HH-17, la hipótesis puede afirmar que mostrar el origen de un estado reduce confirmaciones erróneas. Una explicación rival sostiene que el problema es la falta de autoridad para corregir. Medir únicamente clics no permite distinguirlas.
...
La diferencia evita asociaciones automáticas. Un proyecto puede gobernarse con principios y dominios de PMBOK y emplear Scrum en una parte del trabajo. Un equipo Scrum puede utilizar Kanban para observar el flujo. Un sistema Kanban puede operar sin sprints.

Cualquiera de estas configuraciones puede incluir decisiones predictivas, incrementales o experimentales. Decir que una organización trabaja con PMBOK, Scrum o Kanban todavía no explica qué lógica aplica a cada incertidumbre ni qué evidencia gobierna sus compromisos.

PMBOK aporta una vista amplia de valor, gobernanza, alcance, cronograma, finanzas, interesados, recursos y riesgo. Su octava edición organiza seis principios y siete dominios, e incorpora orientación de procesos que no impone una receta. No obliga a ejecutar cuarenta procesos como una secuencia uniforme.

Permite seleccionar prácticas y relacionarlas con la entrega de valor, pero exige justificar el ajuste. En Hotel Horizonte resulta útil para la migración del PMS, porque deben coordinarse presupuesto, proveedor, ventanas, riesgo, adquisiciones y responsabilidades que exceden el trabajo de un solo equipo.

Scrum aporta empirismo y un ritmo integrado de inspección y adaptación. El Objetivo de Producto orienta una trayectoria. El Objetivo del Sprint concentra un compromiso. La Definición de Terminado establece una condición compartida de calidad para el incremento.

El marco no promete que todo problema se vuelva claro al dividirlo en sprints. Tampoco define por sí solo arquitectura, investigación, operación, presupuesto o gobierno institucional. En el hotel puede organizar el trabajo del equipo, siempre que el incremento sea una capacidad utilizable y que la revisión incluya a quienes sostienen y reciben el servicio.

Kanban aporta una mirada continua sobre el flujo. Obliga a definir qué unidad atraviesa el sistema, dónde comienza y termina, qué estados la transforman, qué trabajo se controla y qué medidas permiten mejorarlo. No prescribe roles ni una iteración temporal fija.

En Hotel Horizonte puede mostrar que una solicitud accesible espera cuatro días antes de ser aceptada, aunque el desarrollo la complete dentro de un sprint. También puede revelar que el límite local del equipo desplaza trabajo pendiente a correos, aprobaciones o consultas de Recepción. Su evidencia corrige una lectura encerrada en ceremonias.

Las tres contribuciones pueden chocar. Una puerta contractual puede congelar alcance mientras la evidencia de uso exige revisarlo. Un Objetivo del Sprint puede favorecer foco y, a la vez, ocultar una espera previa de meses. Un límite de trabajo en curso puede mejorar el flujo interno y excluir solicitudes que todavía no alcanzaron el punto de compromiso. El conflicto no se resuelve eligiendo una marca. Se explicitan frontera, unidad, autoridad y consecuencia, y luego se decide qué práctica conserva la función necesaria.

HH-17 distribuye entonces las lógicas. La migración técnica y la contingencia de temporada requieren anticipación predictiva. La presentación de estados admite iteración con quienes los interpretan. La llegada accesible se entrega como incremento completo para una población delimitada. La prioridad diaria se adapta con señales explícitas y memoria.

Una nueva forma de alerta puede evaluarse experimentalmente si todas las variantes cumplen la obligación. PMBOK ayuda a gobernar el conjunto. Scrum puede organizar una corriente de producto. Kanban vuelve visibles el flujo y las esperas. Ninguno sustituye la decisión metodológica.

La comprobación final no pregunta si se aplicó correctamente una etiqueta, sino si cada compromiso se corresponde con conocimiento, riesgo y posibilidad de revisión. Si el equipo puede nombrar la incertidumbre, mostrar la evidencia, explicar por qué una práctica es adecuada y reconocer su límite, la combinación es defendible. Si sólo enumera eventos, tableros, documentos y puertas, conserva un collage metodológico aunque cada pieza provenga de una fuente reconocida.

## Movimiento 2 · Diseñar combinaciones gobernables
...
## Movimiento 3 · Preparar decisiones que una estrategia deberá componer
...
## Instrumento HH-17: mapa de lógica de intervención
...
1. **Decisión y consecuencia.** Formular la decisión que se intenta habilitar y la consecuencia observable que tendrá para la operación y las personas afectadas.

2. **Incertidumbre dominante.** Nombrar qué no se sabe todavía y distinguir si la duda concierne al problema, al mecanismo, al uso, a la integración o al efecto.

3. **Conocimiento estable.** Separar obligaciones, restricciones y hechos suficientemente comprobados de las hipótesis que todavía requieren aprendizaje.

4. **Lógica elegida.** Asignar a cada decisión una lógica predictiva, iterativa, incremental, adaptativa o experimental y justificar por qué produce el conocimiento necesario.

5. **Hipótesis y mecanismo.** Expresar qué cambio se espera, por qué debería producirse y qué referencia, hipótesis nula o explicación rival permitiría interpretar el resultado.

6. **Evidencia requerida.** Definir qué observación distinguirá las hipótesis y qué procedencia, población y calidad deberá conservar esa evidencia.

7. **Cadencia de revisión.** Fijar cuándo se examinarán supuestos y resultados, de acuerdo con la velocidad del aprendizaje y el costo de demorar una corrección.

8. **Cadencia de entrega.** Precisar qué capacidad utilizable se entregará en cada incremento, sin confundir entrega con mera actualización de artefactos.

9. **Compromiso e irreversibilidad.** Estimar inversión, exposición y costo de salida para que el compromiso crezca sólo cuando la evidencia lo justifique.

10. **Autoridad.** Identificar quién puede continuar, modificar, detener o escalar cada tramo y qué información necesita para ejercer esa atribución.

11. **Criterio de salida.** Declarar la evidencia mínima que permite cerrar, transferir o abandonar una hipótesis sin presentar actividad completada como aprendizaje.

12. **Contingencia y aprendizaje.** Preparar la respuesta ante daño o falla y registrar qué resultado cambiará la lógica, la secuencia o el alcance de la intervención.
...
## Caso de transferencia: diagnóstico asistido en una guardia
...
## Contraejemplo: experimentar con una obligación ya conocida
...
**Elegir una etiqueta para todo el proyecto.**
...
**Confundir iteración con incremento.**
...
**Usar adaptación como permiso para cambiar sin registro.**
...
**Experimentar sin hipótesis ni protección.**
...
**Acelerar el ritmo sin autoridad disponible.**
...
**Mantener una puerta que nunca puede detener.**
...
**Llamar híbrido a una suma de ceremonias.**
...
**Medir actividad en lugar de aprendizaje.**
...
**Tratar la reversibilidad como una simple vuelta atrás técnica.**
...
1. No existe una lógica óptima para todas las decisiones.

2. Iterar mejora una versión; incrementar entrega capacidad utilizable.

3. Adaptar exige límites, evidencia y memoria.

4. Experimentar requiere hipótesis, protección y criterio de interrupción.

5. El compromiso debe crecer con la evidencia y la irreversibilidad.
...
1. ¿Qué diferencia una iteración de un incremento?

2. ¿Cuándo una decisión requiere anticipación aunque exista incertidumbre?

3. ¿Qué vuelve defendible una combinación híbrida?

4. ¿Por qué una reversión técnica no garantiza reversibilidad?

5. ¿Qué condiciones limitan un experimento?

6. ¿Cómo se diseña una puerta con opción real de detener?
...
**Barry Boehm.** Vinculó ciclos de desarrollo con reducción progresiva de riesgo.

**Winston Royce.** Mostró los límites de una secuencia lineal sin retroalimentación.

**Donald Schön.** Explicó la reflexión durante la acción profesional.

**Amy Edmondson.** Investigó las condiciones que permiten aprender de errores, incertidumbre y resultados inesperados sin ocultarlos.

**David Snowden.** Distinguió contextos de decisión que exigen diagnóstico, aprendizaje emergente o acción inmediata.

**Kent Beck.** Vinculó respuesta al cambio, entrega frecuente y retroalimentación técnica en el desarrollo adaptativo.

## Referencias base

- Boehm, B. W. (1988). “A Spiral Model of Software Development and Enhancement”. *Computer*, 21(5), 61 a 72. https://doi.org/10.1109/2.59
...
- Coleman, J., Vacanti, D., Johnson, C., Singh, P., Wester, J., Neverdal, C., Firlit, M., Gilb, T. y Tendon, S. (2025). *The Kanban Guide*. https://kanbanguides.org/the-kanban-guide/

- Project Management Institute y Agile Alliance (2017). *Agile Practice Guide*. https://www.pmi.org/standards/agile

- Project Management Institute (2020). *Tailoring Process as Outlined in the PMBOK Guide, Seventh Edition*. https://www.pmi.org/-/media/pmi/documents/public/pdf/pmbok-standards/pmbok-tailoring-explainer-20-oct-2020.pdf
...
- ISO/IEC/IEEE (2021). *ISO/IEC/IEEE 16085:2021 Systems and software engineering, Life cycle processes: Risk management*. https://www.iso.org/standard/74371.html

- Kurtz, C. F. y Snowden, D. J. (2003). “The New Dynamics of Strategy: Sense-making in a Complex and Complicated World”. *IBM Systems Journal*, 42(3), 462 a 483. https://doi.org/10.1147/sj.423.0462
...
- SEBoK (2026). *Decision Gate*. https://sebokwiki.org/wiki/Decision_Gate_%28glossary%29
