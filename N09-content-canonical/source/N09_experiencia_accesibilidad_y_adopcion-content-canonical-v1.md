# N09 · Experiencia, accesibilidad y adopción no son decoración
...
Una solución es utilizable y puede ser adoptada cuando personas diversas logran comprender, decidir, actuar, corregir y obtener resultados en condiciones reales. La experiencia incluye tanto la interacción visible como el trabajo interno. La accesibilidad exige condiciones verificables y alternativas. La adopción depende del diseño del trabajo, la confianza y los incentivos. Una interfaz fluida no justifica trasladar carga, ocultar riesgos ni excluir excepciones.

Esto no convierte toda diferencia de experiencia en un problema técnico ni promete una solución idéntica para cada persona. Propone una responsabilidad profesional más precisa: declarar qué capacidades deben estar disponibles, para quiénes y en qué condiciones; identificar dónde se interrumpe el recorrido; diseñar alternativas equivalentes; y conservar evidencia para revisar las decisiones.

El criterio de calidad no es la ausencia de fricción ni la cantidad de usuarios activos. Es la posibilidad real de alcanzar un resultado valioso sin cargas, riesgos o exclusiones desproporcionadas.
...
El diseño de interacción se concentra en cómo acciones y respuestas forman una conversación comprensible. Pregunta qué puede hacerse, qué estado existe, qué consecuencia tendrá una acción y cómo se reconoce un error. El diseño de servicios amplía la mirada hacia la promesa completa y conecta puntos de contacto con personas, procesos, reglas, datos y reparación.

La arquitectura de información organiza contenidos y relaciones para que algo pueda encontrarse y comprenderse. El diseño de contenido decide qué se dice, cuándo, con qué precisión y con qué opción de actuar. La accesibilidad atraviesa todas esas decisiones y no constituye una corrección final.

Estas funciones pueden contradecirse. Una UI con menos pasos puede ocultar una decisión relevante. Un recorrido emocionalmente agradable puede apoyarse en trabajo interno insostenible. Una arquitectura de información consistente puede usar categorías que la organización no interpreta igual. Un mensaje breve puede omitir una condición comercial decisiva. Una automatización accesible en el camino ordinario puede perder su alternativa cuando aparece una excepción. Diseñar exige reconocer qué capa produce cada efecto y evitar que una mejora local se declare experiencia completa.

La orientación de ISO 9241-210:2019 organiza un proceso centrado en las personas durante el ciclo de vida: comprender contexto, especificar requisitos, producir soluciones y evaluar. La iteración no debe limitarse a corregir una pantalla. Una prueba puede obligar a revisar una regla, una promesa o la distribución del trabajo. Si el equipo descubre que Recepción carece de autoridad para corregir un estado, la respuesta no es necesariamente crear un botón más visible. Puede requerir cambiar gobierno, contrato o contingencia.

Scolari propone leer la interfaz como una red de relaciones y transformaciones, no como una membrana neutral entre persona y máquina. Esa perspectiva resulta útil en METSI porque una interfaz conecta actores, instituciones, reglas y tecnologías, y al hacerlo distribuye capacidades. El tablero de Hotel Horizonte no sólo representa habitaciones. Decide qué estado resulta visible, qué diferencia puede expresarse y quién aparece como responsable. Cambiar la interfaz puede reorganizar el sistema aunque ningún proceso formal se modifique.

Garrett distingue planos que van de estrategia y alcance hacia estructura, esqueleto y superficie. La secuencia ayuda a evitar que una decisión de color o disposición intente reparar una incoherencia de propósito. N09 no adopta esos planos como receta lineal. Los utiliza para preguntar en qué nivel se originó la discrepancia y qué evidencia corresponde.

Si la promesa de llegada anticipada no contempla capacidad real, mejorar la superficie hace más persuasiva una afirmación defectuosa. Si la promesa es válida y el obstáculo está en localizar la opción, una intervención de arquitectura o interfaz puede ser suficiente.

Hotel Horizonte permite comprobar las diferencias. La UI muestra “preparación completada”. UX incluye la expectativa creada, la espera al llegar y la posibilidad de comprender o corregir. El diseño de interacción define qué ocurre al confirmar. El diseño de servicios conecta esa acción con Housekeeping, Recepción y cerraduras. La arquitectura de información ubica condiciones y alternativas. El contenido explica qué se completó realmente.

La accesibilidad exige que personas diversas puedan recorrer, comprender y reparar. El sistema falla si una sola capa se apropia del diagnóstico.

La evidencia también cambia por función. UI puede evaluarse mediante inspección, errores de interacción y comprensión de controles. UX requiere episodios, relatos y resultados a lo largo del recorrido. El servicio necesita tiempos, handoffs, estados y capacidad de reparación. La arquitectura de información se prueba con búsqueda, clasificación y comprensión. El contenido se contrasta por interpretación y acción. La accesibilidad combina revisión técnica con uso situado y alternativas. Una única puntuación de satisfacción no puede reemplazar este conjunto sin borrar mecanismos.

La decisión profesional consiste en localizar la intervención mínima que preserve la capacidad completa. Puede bastar cambiar una etiqueta cuando el significado está acordado y el error es perceptivo. Puede ser necesario rediseñar proceso y autoridad cuando la pantalla comunica correctamente una regla equivocada. N09 exige declarar qué capa se modifica, qué otras permanecen como supuesto y qué evidencia mostraría una consecuencia desplazada. Así, diseño deja de ser terminación estética y se convierte en una forma de intervenir sobre relaciones.
...
- acción/expectativa de la persona;
- puntos de contacto;
- evidencia visible;
- interacción visible;
- trabajo interno;
...
- autenticación practicable;
- soporte;
- posibilidad de corregir;
- continuidad entre digital y físico.
...
### Primera aplicación de HH-09: de la promesa al primer bloqueo
...
La señal visible es la etiqueta “adaptada”; la acción requerida es reservar; el trabajo de soporte consiste en verificar atributos físicos y disponibilidad; la evidencia es la fecha, procedencia y vigencia de cada atributo.
...
- duplica carga;
- no representa excepciones;
- reduce autonomía;
- crea responsabilidad sin autoridad;
- falla en conectividad;
- contradice incentivos;
- el canal informal resuelve mejor;
- el uso expone desempeño;
- no hubo tiempo/apoyo.
...
- abandono con punto/causa;
- errores y reparación;
- uso de canal alternativo;
- asistencia requerida;
- resultado posterior;
- carga trasladada a equipos;
...
- sin acceso visual continuo;
- sin smartphone propio;
- conectividad intermitente;
- estrés/urgencia;
- idioma o alfabetización distinta;
- asistencia de tercero;
- identidad/documentación no estándar;
- necesidad de más tiempo;
- canal físico inaccesible.
...
### Segunda aplicación de HH-09: probar la alternativa y la carga trasladada
...
### Instrumento de decisión: mapa de recorrido accesible
...
1. **propósito de la persona:** qué intenta conseguir, no qué botón debe presionar;
2. **condiciones relevantes:** idioma, dispositivo, movilidad, conectividad, tiempo, asistencia o presión;
3. **señal visible:** qué estado comunica el servicio y con qué grado de certeza;
4. **acción requerida:** qué esfuerzo, dato, decisión o desplazamiento se solicita;
5. **trabajo que sostiene la transición:** quién verifica, coordina, autoriza o repara;
6. **evidencia crítica:** qué dato permite afirmar que la transición ocurrió efectivamente;
7. **modo de falla:** cómo puede interrumpirse o producir una promesa falsa;
8. **alternativa y reparación:** qué camino equivalente existe y quién tiene autoridad para activarlo.
...
- una base de conocimiento con procedencia y vigencia;
- una forma visible de expresar incertidumbre;
- confirmación antes de acciones con consecuencia;
- equivalencia funcional para teclado, lector de pantalla y otros modos;
- escalamiento humano real, con contexto preservado;
- registro de la promesa y autoridad para repararla;
- monitoreo por poblaciones y modos de falla, no sólo satisfacción promedio.

El auge de IA también modifica la experiencia laboral. Según la OIT, la exposición a IA generativa hace más probable la transformación de tareas que su reemplazo completo. Eso significa que la adopción no puede medirse sólo como sustitución o uso. Debe observar cómo cambian responsabilidad, carga cognitiva, supervisión, aprendizaje y capacidad de impugnar una recomendación.

Un agente que redacta respuestas puede ahorrar tiempo y aumentar el esfuerzo de verificar excepciones. Si ese trabajo de control no se reconoce, la organización interpreta prudencia como resistencia.
...
### Tercera aplicación de HH-09: una promesa accesible que el sistema no puede verificar

Camila organiza un viaje de trabajo y consulta si la habitación es accesible. No pregunta por una categoría abstracta: necesita llegar desde la vereda sin escalones, disponer de espacio lateral junto a la cama y utilizar una ducha sin borde. El sitio muestra un ícono de accesibilidad. El asistente conversacional responde que el hotel cuenta con habitaciones adaptadas.

Camila vuelve a preguntar por la ducha y recibe una afirmación general: “nuestras instalaciones están preparadas para recibir a todos los huéspedes”. Interpreta que la necesidad quedó confirmada y completa la reserva.
...
La disponibilidad para sus fechas requiere confirmación de Operaciones. La respuesta estará disponible antes de las 18”. Esa frase parece menos automática, pero conserva diferencia entre dato, inferencia y compromiso.
...
### Caso de transferencia: inscripción universitaria, contenido y excepciones
...
- experiencia reducida a interfaz;
- accesibilidad como lista de control final;
- usuario promedio;
- adopción medida por inicio de sesión;
- resistencia atribuida a actitud;
- eliminar toda fricción;
- probar solo camino feliz;
- automatizar información no confiable;
- confundir ausencia de reclamos con inclusión;
- trasladar trabajo al usuario sin medirlo.
...
1. **Accesibilidad es poder completar un recorrido, no aprobar una pantalla.**
2. **El usuario promedio es una ficción que oculta variación real.**
3. **Toda fricción debe justificarse por el valor o riesgo que protege.**
4. **El no uso y la adaptación local pueden ser evidencia sobre el diseño del trabajo.**
5. **Una alternativa accesible incluye también excepción y reparación.**

## Glosario esencial

- **Accesibilidad:** capacidad efectiva de personas diversas para percibir, comprender, operar y completar un recorrido.
- **WCAG:** pautas del W3C para accesibilidad del contenido web.
- **Usabilidad:** grado en que personas específicas logran objetivos con eficacia, eficiencia y satisfacción.
- **Adopción:** incorporación sostenible de una solución al trabajo o vida real, no mera activación.
- **Fricción:** esfuerzo, espera o dificultad introducida por un recorrido.
- **Ajuste razonable:** modificación necesaria para permitir participación sin carga desproporcionada.
- **Tecnología asistiva:** herramienta que amplía acceso, como lector de pantalla o control por voz.
- **Recorrido de principio a fin:** secuencia completa desde la necesidad hasta el resultado y su eventual reparación.
- **Alternativa efectiva:** camino disponible cuando el canal o la automatización principal no funciona, con dignidad, tiempo y resultado comparables.

## Preguntas de preparación

1. ¿Qué propiedad del servicio no cabe en WCAG?
2. ¿Cuándo una fricción protege?
3. ¿Qué evidencia distingue resistencia de diseño inviable?
4. ¿Cómo representar accesibilidad en Hotel Horizonte?
5. ¿Qué métrica de adopción sería engañosa?
6. ¿Qué trabajo desplaza el check-in digital?
...
- ISO (2018). *ISO 9241-11:2018 Ergonomics of human-system interaction, Part 11: Usability: Definitions and concepts*. International Organization for Standardization. https://www.iso.org/standard/63500.html
...
- ISO (2025). *ISO/IEC 40500:2025 Information technology, W3C Web Content Accessibility Guidelines (WCAG) 2.2*. International Organization for Standardization. https://www.iso.org/standard/91029.html
- W3C Web Accessibility Initiative (2024). *Accessibility Principles*. https://www.w3.org/WAI/fundamentals/accessibility-principles/
...
- Lazar, J., Goldstein, D. F., y Taylor, A. (2015). *Ensuring Digital Accessibility through Process and Policy*. Morgan Kaufmann. https://doi.org/10.1016/C2013-0-13303-2
- Norman, D. A. (2013). *The Design of Everyday Things: Revised and Expanded Edition*. Basic Books.
- Garrett, J. J. (2011). *The Elements of User Experience: User-Centered Design for the Web and Beyond*, Second Edition. New Riders.
- Scolari, C. A. (2018). *Las leyes de la interfaz: diseño, ecología, evolución, tecnología*. Gedisa.
- Rogers, E. M. (2003). *Diffusion of Innovations*, quinta edición. Free Press.
- Suchman, L. A. (2007). *Human-Machine Reconfigurations: Plans and Situated Actions*. Cambridge University Press. https://doi.org/10.1017/CBO9780511808418
- Parlamento Europeo y Consejo de la Unión Europea (2019). *Directiva (UE) 2019/882 sobre los requisitos de accesibilidad de los productos y servicios*. https://eur-lex.europa.eu/eli/dir/2019/882/oj
...
- Autio, C., Schwartz, R., Dunietz, J., Jain, S., Stanley, M., Tabassi, E., Hall, P., y Roberts, K. (2024). *Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile*, NIST AI 600-1. National Institute of Standards and Technology. https://doi.org/10.6028/NIST.AI.600-1
- Gmyrek, P., Berg, J., Kamiński, K., Konopczyński, F., Ładna, A., Nafradi, B., Rosłaniec, K., y Troszyński, M. (2025). *Generative AI and Jobs: A Refined Global Index of Occupational Exposure*, ILO Working Paper 140. International Labour Organization. https://doi.org/10.54394/HETP0387
