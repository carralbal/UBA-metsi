# N08 · Observar el trabajo invisible

<!-- N08-CONTENT-CONTRACT: canonical-final; content-only; no-layout -->

## Pregunta profesional

¿Qué parte decisiva de un sistema aparece cuando dejamos de mirar sólo el procedimiento y seguimos lo que las personas hacen para que el servicio funcione?
...
Al mediodía, una luz de barrera quedó encendida aunque el brazo ya estaba abajo. El operador no llamó a mantenimiento. Golpeó suavemente la caja con la palma, observó si el indicador cambiaba y anotó el episodio en una libreta. “El sensor falla cuando hay humedad”, explicó. El tablero mostraba una anomalía aislada; la libreta contenía siete casos, todos después de lluvia.

El procedimiento exigía detener la operación ante una señal incierta, pero detenerla cada vez habría bloqueado el puerto. La práctica local sostenía continuidad y, al mismo tiempo, ocultaba una deuda de mantenimiento.
...
Un procedimiento describe el trabajo esperado, pero no contiene todo lo que hace falta para producir un resultado en condiciones reales. La operación incorpora variaciones, interrupciones, coordinación, memoria, interpretación, cuidado y reparación. La diferencia entre el procedimiento y la práctica no es siempre un error ni siempre una virtud. Puede ser adaptación experta, defensa informal, restricción de diseño, incumplimiento peligroso o una combinación de esas posibilidades.

Observar profesionalmente consiste en reconstruir para qué sirve cada acción, qué incertidumbre maneja, qué evidencia usa, qué autoridad requiere y qué consecuencias produce. El propósito no es congelar la práctica actual. Es cambiarla sin destruir las capacidades que hoy mantienen vivo el sistema y sin perpetuar arreglos frágiles o injustos.
...
La invisibilidad puede ser temporal. La preparación ocurre antes del encuentro visible y la reparación después. Puede ser organizacional: un área recibe un dato limpio y no ve quién resolvió contradicciones antes de entregarlo. Puede ser política: reconocer una tarea obligaría a admitir carga, dependencia o riesgo. Puede ser técnica: los registros de aplicación capturan eventos, pero no significado, autoridad ni motivo.

Star y Strauss (1999) muestran que la visibilidad del trabajo no es neutral: depende de categorías, jerarquías y sistemas que vuelven reconocidas ciertas contribuciones y silencian otras.

Hay al menos seis familias frecuentes:

1. **Articulación:** lograr que tareas separadas encajen en tiempo, significado y prioridad.
2. **Verificación:** comprobar que una afirmación o estado merece confianza.
3. **Anticipación:** detectar una condición antes de que se convierta en incidente.
4. **Reparación:** restaurar servicio, datos o relación después de una falla.
5. **Traducción:** convertir vocabulario, identificadores o criterios entre actores.
6. **Cuidado:** contener daño, explicar, negociar y preservar dignidad.
...
### Primera aplicación de HH-08: decidir qué seguir
...
En Hotel Horizonte, el episodio comienza con la confirmación de llegada anticipada. La huésped presenta la reserva; Recepción consulta el PMS; Housekeeping confirma limpieza; Mantenimiento conserva una restricción de cerradura; Comercial definió la promesa y el proveedor sincroniza estados. El blueprint muestra que la pantalla es un punto de contacto dentro de una cadena.

La línea entre visible e interno permite preguntar qué explicación recibe la huésped mientras las áreas resuelven una contradicción y qué capacidad de reparación aparece si el acceso no puede emitirse.

El modelo falla si convierte cada tarea en una caja idéntica o si representa solamente el procedimiento deseado. Las capas deben apoyarse en episodios y señalar incertidumbre, variación y trabajo no reconocido. Una llamada puede permanecer si transporta una restricción que ningún otro canal conserva. Una lista puede sustituirse si su función se incorpora con procedencia y autoridad. La decisión de diseño no busca digitalizar el dibujo, sino preservar o mejorar las capacidades que el trabajo invisible aportaba.
...
En Hotel Horizonte, una recepcionista descubre que la habitación 512 figura como disponible, pero recuerda que Mantenimiento informó una falla intermitente en la cerradura. El PMS permite asignarla. La política comercial premia minimizar la espera. La supervisora está atendiendo otra situación. La recepcionista puede bloquear la habitación, llamar, ofrecer una alternativa o confiar en el sistema.

La pantalla contiene un estado; la práctica exige construir una decisión bajo presión. Si luego todo sale bien, esa decisión puede desaparecer de los registros. Si sale mal, el análisis retrospectivo puede presentarla como incumplimiento individual.
...
Una observación rigurosa pregunta qué señales estaban disponibles, cuáles eran confiables, qué costo tenía verificar y qué posibilidad real existía de escalar. También examina si la persona podía detener el flujo sin ser penalizada. Decir que alguien “tenía que consultar” no alcanza si el canal demora veinte minutos y la fila sigue creciendo.

Decir que “debía seguir el sistema” tampoco alcanza si la organización sabe que ciertos estados llegan tarde. La conducta sólo puede interpretarse dentro de las condiciones que la hicieron razonable, riesgosa o inevitable.
...
- decisiones que dependen repetidamente de “preguntarle a quien sabe”;
- excepciones resueltas fuera de los sistemas sin devolución posterior;
- reconciliaciones manuales que crecen con el volumen;
- personas que actúan como puente permanente entre áreas;
- controles cuya eficacia depende de atención extraordinaria;
- tareas que se completan sólo extendiendo jornada o demorando otras;
- información crítica guardada en conversaciones o archivos personales.
...
Esta distinción importa al diseñar automatización. Una herramienta puede ejecutar la acción visible y omitir la microdecisión que la hacía segura. Si un asistente de IA redacta respuestas a huéspedes, quizá reproduzca el contenido del mensaje pero no advierta cuándo una promesa comercial contradice capacidad operativa.

Si recomienda asignaciones, puede optimizar ocupación y borrar el criterio informal con el que Recepción evitaba ubicar a una persona con movilidad reducida lejos del ascensor. Automatizar la superficie sin modelar la función puede acelerar daño y reducir la posibilidad de que alguien lo detecte.
...
### Instrumento de decisión: registro en capas
...
### Segunda aplicación de HH-08: separar evento, interpretación y pregunta
...
- una regla de negocio con autoridad explícita;
- un estado nuevo y su semántica;
- una señal de incertidumbre o procedencia;
- una contingencia para modo degradado;
- un requisito de calidad o una restricción operativa;
- un cambio de rol o escalamiento;
- una métrica que incluya reparación;
- un experimento para distinguir mecanismos.
...
### Tercera aplicación de HH-08: el incidente de la habitación 512
...
### Caso de transferencia: enfermería y medicación
...
3. **Muestrear condiciones.** Turnos, carga, experiencia, éxito, falla y casos relevantes.
4. **Acordar ética y acceso.** Propósito, datos, consentimiento, límites y derecho a detener.
5. **Preparar artefactos.** Guía, ficha en capas, reloj común y códigos mínimos.
6. **Observar sin explicar demasiado pronto.** Separar descripción, interpretación y pregunta.
7. **Reconstruir significado.** Preguntar después qué señal, criterio o restricción operó.
8. **Triangular.** Contrastar entrevistas, registros, documentos y otros episodios.
9. **Formular mecanismos rivales.** Qué explicaciones compiten y qué evidencia las distingue.
10. **Conectar con decisión.** Qué preservar, cambiar, probar y volver a observar.
...
- **Observar sólo el camino feliz.** Produce diseños frágiles frente a variación.
- **Interpretar todo desvío como culpa.** Oculta restricciones y desalienta evidencia.
- **Romantizar la adaptación local.** Perpetúa deuda, dependencia y riesgo.
- **Medir sólo interacción visible.** Traslada reparación a zonas no contabilizadas.
- **Inferir motivación sin preguntar.** Convierte conducta en rasgo personal.
- **Usar observación para desempeño individual.** Cambia conducta y rompe confianza.
- **Registrar datos sensibles innecesarios.** Aumenta daño sin mejorar decisión.
- **Automatizar forma sin comprender función.** Elimina defensas junto con pasos visibles.
...
1. **El procedimiento describe trabajo esperado; la operación revela trabajo posible.**
2. **Una desviación puede ser error, adaptación o ambas cosas a la vez.**
3. **Lo invisible suele concentrarse en transferencias, esperas, verificaciones y reparaciones.**
4. **Observar no es auditar personas: es investigar las condiciones que producen el resultado.**
5. **Supervisión humana sin tiempo, información, autoridad y alternativa es una ficción.**

## Glosario esencial

- **Trabajo imaginado:** representación simplificada de cómo la organización cree que funciona una operación.
- **Trabajo prescripto:** actividad definida por procedimientos, roles, reglas y modelos formales.
- **Trabajo realizado:** actividad que efectivamente ocurre bajo condiciones concretas.
- **Trabajo revelado:** versión parcial del trabajo que una investigación logra reconstruir.
- **Adaptación local:** forma alternativa de completar una tarea cuando el diseño formal no alcanza.
- **Acompañamiento situado:** seguimiento consentido de una actividad mientras ocurre.
- **Reconstrucción guiada:** recorrido paso a paso de un episodio con apoyo de personas y artefactos.
- **Transferencia:** pasaje de trabajo, información, prioridad y responsabilidad entre actores.
- **Articulación:** trabajo necesario para lograr que actividades distribuidas encajen.
- **Cognición distribuida:** producción de conocimiento mediante personas, objetos, representaciones y entorno.
- **Modo degradado:** operación bajo disponibilidad parcial de tecnología, información o recursos.
- **Retoma de control:** momento en que una persona recupera autoridad operativa desde una automatización.
- **Gestión algorítmica:** uso de sistemas para asignar, monitorear, evaluar o dirigir trabajo.
- **Resiliencia:** capacidad de sostener o recuperar un resultado bajo variación y perturbación.
- **Demanda de falla:** trabajo generado porque el sistema no resolvió correctamente una necesidad anterior.
- **Deriva:** acumulación gradual de adaptaciones que puede debilitar defensas sin una decisión única visible.

## Preguntas de preparación

1. ¿Qué diferencia existe entre trabajo imaginado, prescripto, realizado y revelado?
2. ¿Qué adaptación de Hotel Horizonte conserva una capacidad y, a la vez, introduce riesgo?
3. ¿Por qué una transferencia no puede reducirse a mover datos?
4. ¿Qué regla permite separar descripción, interpretación y pregunta durante una observación?
5. ¿Qué condiciones distinguen una investigación de una auditoría punitiva?
6. ¿Qué condiciones vuelven real la supervisión humana de una IA y qué debería observarse después de automatizar una tarea?
...
- Dekker, S. (2014). *The Field Guide to Understanding “Human Error”* (3.ª ed.). CRC Press.
- Weick, K. E. y Sutcliffe, K. M. (2015). *Managing the Unexpected: Sustained Performance in a Complex World* (3.ª ed.). Jossey-Bass.
- Hutchins, E. (1995). *Cognition in the Wild*. MIT Press.
- Strauss, A. (1988). “The Articulation of Project Work: An Organizational Process”. *The Sociological Quarterly, 29*(2), 163 a 178. https://doi.org/10.1111/j.1533-8525.1988.tb01249.x
- Star, S. L. y Strauss, A. (1999). “Layers of Silence, Arenas of Voice: The Ecology of Visible and Invisible Work”. *Computer Supported Cooperative Work, 8*, 9 a 30. https://doi.org/10.1023/A:1008651105359
- Trist, E. L. y Bamforth, K. W. (1951). “Some Social and Psychological Consequences of the Longwall Method of Coal-Getting”. *Human Relations, 4*(1), 3 a 38. https://doi.org/10.1177/001872675100400101
...
- Gmyrek, P., Berg, J., Kamiński, K., Konopczyński, F., Ładna, A., Nafradi, B., Rosłaniec, K. y Troszyński, M. (2025). *Generative AI and Jobs: A Refined Global Index of Occupational Exposure*. ILO Working Paper 140. https://doi.org/10.54394/HETP0387
- Milanez, A., Lemmens, A. y Ruggiu, C. (2025). “Algorithmic Management in the Workplace: New Evidence from an OECD Employer Survey”. *OECD Artificial Intelligence Papers*, 31. https://doi.org/10.1787/287c13c4-en
