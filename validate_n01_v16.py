...
ROOT = HERE / "N01-v16-final"
HTML = ROOT / "index.html"
CSS = ROOT / "magazine.css"
DIAGRAM = ROOT / "diagrams" / "N01-mapa-decision.svg"
PDF = ROOT / "output" / "N01-METSI-lectura-previa-v16-final.pdf"
BASELINE_PDF = HERE / "N01-v15-final" / "output" / "N01-METSI-lectura-previa-v15-final.pdf"
...
def main() -> None:
    ...
    checks = [
        ...
        check("cover_eyebrow_contrast_at_least_4_5", candidate_contrast["white_contrast_ratio"] >= 4.5 and candidate_contrast["white_contrast_ratio"] > baseline_contrast["white_contrast_ratio"], {"v15": baseline_contrast, "v16": candidate_contrast}),
