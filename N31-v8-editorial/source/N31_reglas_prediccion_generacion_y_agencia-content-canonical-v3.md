...
La discusión inicial se concentra en el modelo: tamaño, proveedor, precisión y fluidez. Sin embargo, esas propiedades no definen si la inteligencia artificial es pertinente. Antes hace falta delimitar la tarea, el propósito, la población, la alternativa sin IA y la consecuencia de equivocarse. Consultar una regla vigente, estimar una probabilidad, redactar una explicación y ejecutar una inscripción son capacidades diferentes aunque aparezcan dentro de la misma conversación.

La reconstrucción separa cinco operaciones. Una regla valida correlatividades formales. Un buscador recupera el plan y las resoluciones. Un modelo predictivo estima riesgo de abandono. Un sistema generativo redacta opciones. Un agente elige herramientas y puede producir efectos en otros sistemas. La interfaz ocultaba esas diferencias bajo un único verbo, “resolver”, y hacía que una respuesta plausible pareciera tener la misma autoridad que una norma.

Surgen explicaciones rivales para el daño. El asistente pudo recuperar una versión desactualizada del plan. También pudo interpretar mal una excepción correcta. Otra posibilidad es más incómoda: aun con información perfecta, el sistema no debía decidir porque la beca, el trabajo y el proyecto formativo exigían juicio situado. Mejorar el modelo sólo atiende la primera hipótesis. Las otras requieren procedencia, límites de autoridad y una alternativa humana accesible.
...
La inteligencia artificial es pertinente cuando una capacidad concreta agrega valor frente a una alternativa identificada y su incertidumbre puede gobernarse en relación con la consecuencia. Regla, predicción, generación y agencia no son grados de sofisticación: producen afirmaciones y efectos diferentes, por lo que exigen fuentes, pruebas, límites y autoridades distintas. Una demostración fluida no establece necesidad ni permiso. La intervención debe comparar la ruta con IA y la ruta base, definir qué juicio permanece en personas capaces de ejercerlo y conservar una condición practicable de no uso. Si comienza por el modelo, puede automatizar una decisión que la organización todavía no comprendió.
