# N25 · Flujo más allá de las ceremonias: colas, lotes, esperas y aprendizaje
...
1. **Unidad y propósito:** qué cambio seguimos y qué necesidad debía atender.
2. **Dos comienzos:** fecha de demanda reconocida y fecha de compromiso de capacidad.
3. **Salida observable:** cuándo se usó la capacidad dentro del alcance acordado y cómo podía repararse.
4. **Trabajo y espera:** períodos activos, colas, bloqueos y motivo de cada pausa.
5. **Transferencias:** quién recibió el trabajo, con qué contexto y cuántas veces volvió.
6. **Políticas:** límites de trabajo abierto, prioridad de urgencias y criterio de validación.
7. **Efecto y reparación:** qué muestran los episodios del servicio, qué señal llegó y qué cambió por ella.
...
### Medir velocidad como resultado
...
### Ocupar a todo el mundo todo el tiempo
...
### Reducir lotes hasta entregar fragmentos inútiles
...
### Recibir señales sin poder actuar
...
1. El reloj de quien espera puede comenzar semanas antes del reloj del equipo.
2. Una tarea cerrada no equivale necesariamente a una capacidad en uso.
3. Menos trabajo simultáneo puede permitir terminar antes, aunque al principio se inicien menos tareas.
4. Una espera se investiga antes de eliminarla: algunas protegen y otras sólo acumulan demora.
5. El feedback produce aprendizaje cuando modifica una decisión y su efecto se vuelve a observar.
...
1. Tomá la modificación de la señal en Hotel Horizonte. ¿Cuál es su inicio desde la demanda? ¿Cuál es su salida? ¿Por qué no alcanza con decir «Tecnología terminó»?
2. De los 46 días, 38 fueron espera. ¿Qué información pedirías para distinguir una espera protectora de una que conviene modificar?
3. ¿Qué podría salir mal si el hotel limita a tres las correcciones activas y deja las demás solicitudes fuera del tablero?
4. Si Mariela valida semanalmente, ¿qué resultado esperarías ver y qué efecto no deseado controlarías?
5. ¿Por qué un sprint terminado no prueba que el flujo de una necesidad terminó?
6. En la submuestra de diez unidades, compará una de instrumentación con una de cobertura accesible. ¿Qué dato falta antes de afirmar que una clase de trabajo «es más lenta»?
...
**Fernando Flores.** Ayuda a entender el trabajo como coordinación de compromisos entre personas; una promesa necesita cumplimiento y reparación.

**Paulo Freire.** Vincula diálogo y acción situada; las personas afectadas participan en la comprensión del problema, no sólo en la aprobación final.

**David Anderson.** Aporta límites de trabajo en curso y políticas explícitas para observar y gobernar el flujo.

**Wil van der Aalst.** Muestra cómo reconstruir recorridos reales a partir de registros de eventos y compararlos con el proceso declarado.

**Werner Vogels.** Relaciona operación de servicios, consistencia y recuperación con las promesas hechas a quienes los usan.

**Kent Beck.** Vincula cambios pequeños, pruebas y feedback frecuente, sin confundir frecuencia de entrega con resultado.
...
- Coleman, J. et al. (2025). *The Kanban Guide*. https://kanbanguides.org/the-kanban-guide/
...
- ISO/IEC (2018). *ISO/IEC 20000-1:2018 Information technology, Service management, Part 1*. https://www.iso.org/standard/70636.html
