...
## El modelo cambió sin que cambiara el proyecto
...
Gobernar la IA es mantener una representación vigente del sistema sociotécnico y de sus dependencias. Requiere inventario, responsabilidad asignada, procedencia, control de cambios, monitoreo, incidentes, reparación y retiro.

La función de gobierno crea un registro vivo por uso y no sólo por proveedor. Vincula cada capacidad con población, fuentes, versión, permisos, evaluación, responsable con autoridad, incidentes y condición de salida.
...
N33 cierra el Bloque G. Recibe de N31 el análisis de pertinencia y de N32 la evidencia de evaluación, y los transforma en un gobierno institucional capaz de sostener, limitar y retirar.
...
La aprobación de un sistema de inteligencia artificial pertenece a un uso y a una configuración sociotécnica verificable, no al nombre comercial de un modelo. Si cambian fuentes, versión, permisos, proveedor, población o contexto sin reabrir evidencia y responsabilidad, el permiso pierde vigencia; por eso el gobierno debe mantener inventario vivo, disparadores de revisión, reparación y retiro capaces de suspender el uso antes de que el incidente haga visible el cambio.
