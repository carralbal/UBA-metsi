# N33 · Gobierno vivo de IA: inventario, responsabilidad, datos, proveedores, cambios, incidentes, reparación y retiro

## Pregunta profesional

¿Cómo mantener bajo control un sistema de inteligencia artificial que cambia mientras se usa y depende de datos, modelos, personas y proveedores distintos?
...
La investigación no culpa de inmediato al modelo. Tal vez influyó el cambio de versión. Tal vez los perfiles históricos repitieron criterios que la empresa decía querer cambiar. También pudo importar un cambio de función: el sistema dejó de ordenar datos entregados y empezó a buscar información nueva. Incluso si cada resultado fuera correcto, seguiría existiendo un problema de gobierno. Nadie autorizó ese uso ampliado ni informó a las personas afectadas.

Un inventario útil no es una lista de productos. Registra usos concretos. Para cada uso explica para qué sirve, sobre quién actúa, quién puede decidir, qué datos y modelos utiliza, qué permisos tiene, cómo se evalúa, qué incidentes ocurrieron y cómo se puede reclamar o retirar. Si dos equipos usan el mismo servicio para decisiones distintas, necesitan registros separados. Si cambia una fuente o una capacidad, el uso debe revisarse.
...
El gobierno debe servir también cuando ya existe un daño. La candidata necesita una revisión que pueda corregir la decisión, no una explicación genérica. La organización suspende el uso ampliado y reconstruye las decisiones afectadas. Distingue una falla técnica de un problema de derechos, trato u oportunidad. Si retira el sistema, debe conservar la continuidad del trabajo, la evidencia necesaria y una alternativa para quienes están en proceso.
...
«El asistente aseguró que la habitación servía», dijo Lucía. «La ficha comercial lo afirma, pero Operaciones todavía no lo confirmó», respondió Mariela. Ricardo preguntó: «¿Qué versión y qué fuentes usó en ese momento?». Federico explicó: «Puedo reconstruir una parte, pero el proveedor ya reemplazó el modelo y no conservamos todos los datos». En pocas frases aparece el problema completo: la respuesta produjo una consecuencia, pero la organización no puede reconstruir el sistema que la generó.
...
No se aprueba un nombre comercial para siempre. Se aprueba un uso concreto, para una población concreta y con una configuración que pueda comprobarse. Si cambian el propósito, las fuentes, la versión, los permisos, el proveedor, la autonomía o el contexto, también puede dejar de valer la evidencia anterior. Un gobierno vivo une inventario, autoridad, origen de datos y modelos, evaluación, monitoreo, incidentes, reclamos, reparación y retiro. No se mide por la cantidad de políticas publicadas. Se mide por la capacidad de detectar un cambio importante, limitar el uso, reconstruir decisiones y corregir consecuencias antes de que la aprobación quede sólo en un acta vieja.

Para pasar de la idea a una decisión hace falta mantener inventario, responsable, finalidad, datos, proveedores, cambios, incidentes, reparación y retiro durante todo el ciclo de vida de IA. Así se distinguen descripción, explicación y compromiso, tres movimientos que suelen mezclarse. El resultado es una argumentación que otra persona puede revisar sin tener que aceptar la autoridad de quien la produjo.

Consideremos un ejemplo de baja escala: un modelo aprobado cambia cuando se actualizan datos, prompt, proveedor o integración; cada modificación puede reabrir la evaluación. Seguirlo de punta a punta permite reconocer primero el fenómeno simple y luego las relaciones que vuelven insuficiente la explicación inicial. Esa es la progresión de lo general a lo particular que propone la colección.

La tesis no autoriza cualquier uso. Su contraejemplo es tratar la revisión inicial como permiso permanente o documentar políticas sin capacidad para detener, reparar y retirar el sistema. Allí se vuelve visible que una técnica correcta puede ser inadecuada para cierto riesgo, población o momento. La calidad depende del uso, no del prestigio de la herramienta.

Aplicado a Hotel Horizonte, Elena autoriza alcance, Federico registra versiones, Lucía supervisa y los incidentes conservan reparación para huéspedes concretos. La continuidad del caso permite comparar la nueva lectura con las anteriores y evita inventar una situación distinta para confirmar cada concepto.

De aquí se desprende una responsabilidad concreta: hacer del gobierno una práctica operativa y no un expediente; N34 reconstruirá la cadena completa de intervención. Profesores y estudiantes pueden discutirla con ejemplos, objeciones y evidencia; no necesitan memorizar una definición aislada ni aceptar una receta cerrada.
...
Elham Tabassi organiza en el marco de NIST un gobierno de IA que asigna responsabilidades y mantiene unidos el contexto, la medición del riesgo y las acciones para tratarlo durante todo el ciclo de vida.

Camille Autio y su equipo detallan en el perfil de NIST para IA generativa riesgos sobre origen de la información, respuestas inventadas, seguridad, privacidad y dependencia de proveedores. Todos requieren controles continuos.

ISO/IEC 42001 exige que política, objetivos, responsabilidades, evaluación y mejora formen un sistema de gestión. No alcanza con publicar declaraciones separadas.

La Disposición 2/2023 aporta una referencia argentina sobre trazabilidad, protección de datos, no discriminación, trabajo multidisciplinario y atención a las personas.

El Reglamento de IA de la Unión Europea reparte obligaciones entre proveedores y organizaciones que usan los sistemas según el uso y el riesgo. También exige supervisión y trazabilidad.
...
Inioluwa Raji y su equipo muestran que una auditoría interna necesita roles claros, documentación, revisión y capacidad real para actuar sobre lo descubierto.

Margaret Mitchell y su equipo proponen documentar el desempeño, los usos previstos y los límites de cada modelo.

Timnit Gebru y su equipo proponen documentar por qué se creó un conjunto de datos, qué contiene, cómo se reunió y para qué puede usarse.

Virginia Dignum distribuye responsabilidades entre diseño, organización, uso y supervisión sin permitir que todos terminen diciendo que la decisión pertenecía a otro.

Madeleine Elish muestra cómo una organización puede dejar a una persona visible para recibir la culpa, pero sin autoridad real para controlar el sistema.

Kate Crawford sitúa la IA dentro de cadenas materiales, laborales e institucionales que una simple lista de modelos no puede mostrar.

Cathy O’Neil muestra que la opacidad, la escala y la falta de apelación pueden convertir una medida aparentemente neutral en un daño persistente.
...
Una nueva población, un permiso de escritura o una vía de reparación que dejó de funcionar pueden elevar la respuesta requerida aunque la ficha conserve el mismo color.
...
NIST y ISO/IEC 42001 aportan aquí lentes complementarias. NIST pregunta cómo el tercero modifica el mapa de riesgo y qué capacidad conserva quien despliega. ISO exige insertar selección, evaluación y seguimiento del proveedor dentro del sistema de gestión.

El Código europeo para IA de propósito general aporta compromisos para quienes adhieren, pero sus evidencias no sustituyen la evaluación situada del hotel y su capítulo de seguridad no se presume aplicable a todo modelo. La comparación impide presentar una certificación, una firma voluntaria y una obligación legal como sellos intercambiables.
...
Estas lentes conducen a pruebas distintas. Se mide si el canal puede encontrarse, si la revisión cambia el estado y si la persona revisora puede ordenar reparación sin pedir autorización a quien produjo la decisión cuestionada.

HH-33 ensaya tres reclamos equivalentes por web, teléfono y mostrador. El equipo compara información recibida, tiempo, carga y resultado, y observa si una persona con necesidad de accesibilidad enfrenta pasos adicionales. Un reclamo resuelto sólo en el canal donde interviene Lucía revela dependencia y no una garantía institucional.

La reparación se considera cerrada cuando el estado fue restituido, la persona fue informada, el efecto residual quedó evaluado y el mecanismo que produjo el daño ingresó al control de cambios. Si sólo se corrige la reserva, el caso individual mejora pero el sistema conserva la causa.
...
La mejora continua necesita evidencia sobre el propio gobierno. El hotel mide tiempo para registrar, responder y retirar, cantidad de excepciones vencidas y acciones cuyo efecto fue verificado. No premia cantidad de reuniones o formularios. Las auditorías seleccionan usos y reconstruyen decisiones de punta a punta; sus hallazgos modifican controles y recursos.

La dirección revisa también incentivos que empujan a ocultar incidentes o ampliar funciones fuera del alcance aprobado. Un sistema de gestión eficaz vuelve más rápida la decisión bien fundada, no simplemente más documentada.

Raji y sus coautores muestran que una auditoría interna sólo cierra la brecha de responsabilidad cuando la organización puede actuar sobre sus hallazgos. Mitchell y sus coautores aportan documentación de desempeño, uso previsto y límites del modelo; Gebru y sus coautores hacen examinables origen, composición y decisiones sobre datos. Esos artefactos responden preguntas diferentes.

Una model card no prueba licitud de datos, una datasheet no demuestra desempeño del uso y una auditoría no reemplaza a la autoridad que debe limitarlo. HH-33 los enlaza con versión, población, decisión y reparación para que ninguno funcione como certificado aislado.

ISO/IEC 42001 estructura política, objetivos, roles, evaluación y mejora como un sistema repetible. El AI RMF de NIST permite comprobar si ese sistema sigue mapeando y tratando el riesgo concreto cuando cambia el contexto. La recomendación argentina añade preguntas sobre destinatarios, datos, trazabilidad y equipos multidisciplinarios relevantes para la decisión local.

El hotel prueba la integración recorriendo una objeción desde Recepción hasta Dirección y de regreso a la operación. Si la revisión identifica una brecha pero presupuesto, permisos o contrato no cambian, existe aprendizaje documental sin gobierno vivo.

La eficacia del sistema se revisa también contra una explicación rival. Una reducción de incidentes puede reflejar mejores controles, menor uso o menor disposición a reclamar. Por eso el tablero combina tasas con exposición, episodios y accesibilidad del canal. La auditoría selecciona casos favorables y adversos, incluye a quienes soportan trabajo de reparación y conserva desacuerdos.

La mejora se acredita cuando una decisión, un recurso o una frontera cambia y luego se observa su efecto. Esta exigencia evita que una cadencia de comités sea confundida con capacidad institucional.
...
1. **Uso y propósito.** Nombrar la tarea autorizada y la decisión que el sistema puede o no puede influir.

2. **Frontera.** Incluir datos, recuperación, modelo, reglas, interfaces, personas, proveedores y acción posterior.

3. **Población y consecuencia.** Delimitar exposición, grupos afectados, derechos comprometidos y posibilidad de reparación.

4. **Responsable con autoridad.** Asignar autoridad y recursos para limitar, suspender, investigar y retirar el uso.

5. **Riesgo.** Clasificar el uso por consecuencia y contexto, con fundamento y fecha de revisión.

6. **Datos y modelos.** Documentar procedencia, límites conocidos, versión y transformaciones que afectan la salida.

7. **Proveedor.** Establecer notificación de cambios, acceso a evidencia, incidentes, continuidad y salida.

8. **Versión y cambio.** Vincular configuración desplegada con evaluación, aprobación y período efectivo.

9. **Evaluación.** Resumir cobertura, severidad, desigualdad, robustez y desempeño del equipo formado por personas e IA.

10. **Monitoreo.** Definir señales de calidad, comportamiento, impacto y escalamiento por población.

11. **Incidente y reparación.** Prever detección, contención, comunicación, contestación y restitución a personas afectadas.

12. **Retiro.** Definir continuidad de la tarea, revocación de accesos y conservación legítima de evidencia.
...
La revisión selecciona un uso activo del asistente y reconstruye su frontera desde la consulta hasta la decisión de Recepción. Compara versión desplegada, fuentes, permisos, población, evaluación vigente y autoridad capaz de suspender.

Luego simula un cambio silencioso del proveedor y un incidente donde una respuesta inventada produce una compensación improcedente. El registro debe detectar la variación, contenerla, permitir contestación y conservar una alternativa operacional durante el retiro.

N33 aprueba cuando la persona responsable puede demostrar por qué el uso sigue autorizado hoy y qué evidencia lo haría retroceder. Una certificación o un inventario sin cambio, reparación y salida no constituyen gobierno vivo.

La devolución separa ausencia de registro, registro desactualizado y falta de capacidad para actuar. La primera exige descubrir y clasificar; la segunda, conectar disparadores de cambio; la tercera, modificar autoridad, recursos o alternativa. Agregar campos no corrige ninguna por sí solo. Elena revisa si la decisión llegó a Recepción y si la persona afectada pudo obtener reparación. El gobierno se demuestra en esa secuencia, no en la apariencia completa del inventario.

El ejercicio concluye con una decisión fechada sobre continuar, limitar o retirar. El acta conserva alcance, riesgo residual, desacuerdos y evidencia que obligaría a reabrir. Un uso puede continuar con menor autonomía mientras se completa una prueba, pero no mantener permisos incompatibles con la incertidumbre reconocida. N34 recibirá ese registro como parte de una cadena mayor, por lo que cada conclusión debe conservar su vínculo con el problema y la consecuencia que justificaron gobernarla.
...
Cumplir una norma no agota la decisión ética ni operacional. El Reglamento de IA de la Unión Europea, los marcos de NIST, ISO 42001 y la Disposición argentina 2/2023 aportan, según cada fuente, obligaciones jurídicas, criterios para un sistema de gestión y prácticas voluntarias. El uso situado conserva población, poder y consecuencias propias. N33 documenta correspondencias sin convertirlas en equivalencias.

Un control puede satisfacer una exigencia formal y no permitir que Lucía corrija una promesa. La evidencia de cumplimiento se integra con episodios y capacidad de reparación.
...
En HH-33, conservar el mismo nombre comercial no autoriza a asumir continuidad: la versión activa debe superar otra vez los casos críticos antes de recuperar acciones automáticas. El marco regulatorio y los estándares orientan controles, mientras los episodios muestran si funcionan en el contexto argentino y en el turno real. Gobernar no equivale a impedir toda innovación.

Permite aprender bajo exposición delimitada, distribuir autoridad y responder por consecuencias incluso cuando parte del sistema permanece opaca o depende de terceros.

## Cinco píldoras para recordar

1. El objeto de gobierno es el uso sociotécnico, no el nombre comercial del modelo ni la licencia adquirida.

2. Un inventario pierde valor si no detecta cambios de datos, instrucciones, herramientas, permisos o población.

3. La persona responsable necesita autoridad y recursos para limitar, reparar y retirar; un contacto nominal no gobierna.

4. Todo cambio material reabre la evaluación correspondiente aunque el proveedor conserve el mismo producto.

5. Sin un canal que pueda cambiar la decisión y reparar su consecuencia, la posibilidad de reclamar es sólo formal.
...
1. ¿Qué uso de IA podría quedar fuera de un inventario organizado sólo por proveedores o licencias?

2. ¿Qué componente humano o técnico fuera del modelo cambia la consecuencia del sistema?

3. ¿Qué puede hacer realmente la persona responsable cuando aparece un daño o un cambio silencioso?

4. ¿Qué evento obligaría a reclasificar el riesgo y repetir la evaluación?

5. ¿Qué obligaciones hacia el proveedor permiten detectar cambios, investigar incidentes y salir?

6. ¿Cómo puede una persona afectada objetar la decisión y obtener una reparación efectiva?
...
**Inioluwa Deborah Raji.** Propone auditorías internas que convierten responsabilidad general en alcance, evidencia y acciones organizacionales.

**Elham Tabassi.** Lidera un marco de gestión de riesgo que conecta gobierno, contexto, medición y tratamiento a lo largo del ciclo de vida.

**Timnit Gebru.** Desarrolla datasheets para volver examinables procedencia, composición, decisiones y usos previstos de conjuntos de datos.

**Kate Crawford.** Sitúa los sistemas de IA dentro de infraestructuras materiales, relaciones laborales y concentraciones de poder.

**Virginia Dignum.** Integra diseño, implementación, uso y gobierno bajo responsabilidades distribuidas pero no diluidas.

**Cathy O’Neil.** Advierte cómo opacidad, escala y ausencia de apelación pueden institucionalizar decisiones dañinas.
...
- Comisión Europea (2025). *General-Purpose AI Code of Practice*. https://digital-strategy.ec.europa.eu/en/policies/contents-code-gpai
...
- Mitchell, M. et al. (2019). “Model Cards for Model Reporting”. *Proceedings of the Conference on Fairness, Accountability, and Transparency*, 220 a 229. https://doi.org/10.1145/3287560.3287596

- Gebru, T. et al. (2021). “Datasheets for Datasets”. *Communications of the ACM*, 64(12), 86 a 92. https://doi.org/10.1145/3458723
...
- Subsecretaría de Tecnologías de la Información (2023). *Disposición 2/2023, Recomendaciones para una Inteligencia Artificial Fiable*. https://www.argentina.gob.ar/normativa/nacional/norma-384656/texto
