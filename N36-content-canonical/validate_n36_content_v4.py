#!/usr/bin/env python3
"""Validate and manifest the N36 pedagogical-readability rewrite."""
...
ROOT = PACKAGE.parent
SOURCE = PACKAGE / "source" / "N36_practica_reflexiva_y_aprendizaje_profesional-content-canonical-v4.md"
...
def main() -> None:
    ...
    manifest = {
        "document": "N36",
        "stage": "content-canonical-v4-readability-pattern",
