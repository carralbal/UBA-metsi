...
## El sprint que duraba dos semanas y el cambio que tardaba cuatro meses
...
El calendario de dos semanas organiza reuniones y compromisos, pero no coincide con el tiempo que una necesidad permanece dentro del sistema. El pedido comenzó cuando Recepción documentó una reasignación y terminó cuando todos los turnos pudieron resolver el episodio con la regla corregida. Entre ambos momentos atravesó decisiones, colas y devoluciones que pertenecen a varias áreas. Ningún tablero local contenía la trayectoria completa.

La velocidad estable tampoco demuestra previsibilidad. Puede significar que el equipo completa una cantidad semejante de tareas mientras los casos esperan fuera de su frontera. Si análisis acepta pedidos sólo cuando comienza a trabajar, el tiempo previo desaparece. Si desarrollo cierra al desplegar, la espera de validación desaparece. Si Operaciones resuelve manualmente y no reabre la tarea, el retrabajo desaparece. Cada frontera mejora su medida y el sistema conserva la demora.

El flujo requiere elegir una unidad con identidad y no mezclar niveles. N14 siguió el episodio operativo del huésped para comprender el proceso de servicio de punta a punta. N25 conserva esa unidad para observar consecuencias, pero analiza como unidad principal el cambio que nace de una necesidad y termina como capacidad usada, observada y reparable. La solicitud puede dividirse en varias tareas y atravesar responsables o sistemas, pero debe conservar el vínculo con la demanda original. Sin esa continuidad, el inventario de cambios se fragmenta y la medición pierde significado.

La espera no es un residuo homogéneo. Parte proviene de lotes, otra de prioridades, otra de falta de autoridad y otra cumple una función protectora. Una revisión de seguridad puede evitar daño; una aprobación duplicada puede existir por historia. Reducir tiempo sin clasificar la espera puede eliminar un control necesario o acelerar trabajo hacia una restricción que no puede absorberlo. N25 exige comprender el mecanismo antes de intervenir.

El objetivo tampoco es convertir a cada persona en un recurso siempre ocupado. Los sistemas con alta variabilidad necesitan margen para resolver excepciones y sostener calidad. Maximizar utilización local aumenta colas, cambios de contexto y tiempo de respuesta. La mejora profesional se mide sobre el resultado de punta a punta y las condiciones de quienes trabajan, no sobre la apariencia de actividad continua.

## Hotel Horizonte: el tiempo que el tablero no mostraba

HH-24 limitó la cartera a cobertura accesible e instrumentación de eventos. En HH-25, el tablero muestra avance semanal, pero una modificación de la instrumentación tarda cuarenta y seis días desde la necesidad hasta el uso. Esa modificación es la unidad de cambio que atraviesa el sistema de trabajo. Los episodios de llegada y reasignación siguen siendo la unidad operacional definida en N14 y permiten verificar si el cambio mejora o deteriora el servicio. No se trata de la corrección de cobertura accesible que en la apertura acumuló ciento dieciocho días, sino de la segunda apuesta activa de HH-24. Federico Müller mide ocho días de trabajo activo; el resto transcurre en espera de definición, revisión, ventana técnica y validación de Operaciones.

Lucía Ferreyra reconstruye el recorrido de la modificación desde el episodio que originó la necesidad hasta su uso en todos los turnos y encuentra cuatro colas invisibles. Los episodios de reasignación se conservan como evidencia del resultado y no se cuentan como si fueran tareas del cambio. Mariela Benítez valida cambios en lotes mensuales porque no conoce qué versión rige en cada piso. Camila Duarte introduce urgencias que desplazan obligaciones sin registrar el costo. Ricardo Sosa redefine inicio y salida, limita trabajo en curso y hace visible edad, bloqueos y handoffs.
...
Un sistema de cambio sólo fluye cuando la unidad conserva identidad desde la demanda reconocida hasta una capacidad en uso y sus efectos se contrastan sobre el resultado de servicio que pretende modificar. Falla cuando la velocidad local o la cadencia ceremonial ocultan colas, trabajo abierto y espera trasladada a otras áreas o al huésped. La implicación profesional es gobernar fronteras, trabajo en curso, lotes, feedback y reparación sin confundir la unidad de cambio de N25 con el episodio operacional estudiado en N14.
...
## Movimiento 1 · Seguir la unidad de valor de punta a punta
...
También se distinguen dos inicios. El tiempo desde la demanda comienza cuando una necesidad reconocible entra al sistema, aunque todavía no se haya aceptado trabajar sobre ella. El tiempo desde el compromiso comienza cuando la opción atraviesa una política explícita de entrada y consume capacidad. Anderson (2010) y la Guía Kanban (Kanban Guides, 2025) exigen definir el flujo y sus puntos de comienzo y final. HH-25 informa ambos relojes: el primero muestra la espera que soporta quien demanda; el segundo permite gobernar trabajo en curso sin esconder una cola previa.
...
## Movimiento 2 · Reducir trabajo en curso, lotes y esperas
...
## Movimiento 3 · Cerrar feedback y gobernar el flujo
...
### Instrumento HH-25: mapa de flujo real
...
1. **Unidad de valor.** Definir qué necesidad recorre el sistema y qué condición permite afirmar que produjo un resultado utilizable.

2. **Inicio y salida.** Fijar eventos observables de entrada y cierre para que el tiempo de flujo no dependa de fronteras convenientes.

3. **Demanda.** Registrar llegadas por tipo, volumen y variabilidad, incluidas urgencias, retrabajo y trabajo invisible.

4. **Trabajo en curso.** Contar unidades iniciadas y todavía no cerradas a lo largo de todo el flujo, no sólo dentro de un equipo.

5. **Colas.** Localizar dónde espera el trabajo, qué recurso o decisión lo detiene y qué política ordena su avance.

6. **Tiempo activo.** Medir períodos en que la unidad recibe trabajo efectivo y distinguirlos del calendario total.

7. **Espera.** Clasificar demora por cola, dependencia, autorización, lote o protección necesaria antes de proponer eliminarla.

8. **Lote.** Indicar cuántas unidades o cuánto cambio se acumula antes de transferir y qué costo impide reducirlo.

9. **Handoffs.** Mapear transferencias de trabajo, información y autoridad, incluidas aclaraciones y devoluciones que generan retrabajo.

10. **Feedback.** Precisar qué señal vuelve desde uso u operación, cuánto tarda y quién puede cambiar una decisión a partir de ella.

11. **Políticas.** Hacer explícitas reglas de admisión, prioridad, límites de trabajo en curso, escalamiento y cierre.

12. **Reparación.** Incluir detección, respuesta, restauración y aprendizaje como parte del flujo, con responsables y tiempos observables.
...
La unidad reconstruida de instrumentación ofrece un ejemplo completo. El reloj desde la demanda suma cuarenta y seis días: ocho de trabajo activo y treinta y ocho de espera. Nueve días corresponden a definición, doce a disponibilidad de ambiente, once a revisión técnica y seis a validación de Operaciones. La eficiencia de flujo descriptiva es 8 dividido 46, aproximadamente 17 por ciento. Esa proporción no convierte los treinta y ocho días en desperdicio: el equipo debe explicar qué parte protegía una condición, qué parte surgía del lote mensual y qué parte dependía de una autoridad ausente.

El registro mantiene cuatro hitos sin cambiar la salida final. La solicitud se reconoce el día cero, se compromete cuando ingresa como una de las dos apuestas de HH-24, queda técnicamente disponible antes de validación y termina cuando todos los turnos usan la señal y pueden reparar una discrepancia. El trabajo en curso se cuenta desde el compromiso; la experiencia de demora se informa desde la demanda. Las veinte unidades de la muestra conservan ambos relojes, reaperturas y datos faltantes. Mediana, percentil alto y edad de casos abiertos acompañan al promedio.
...
### Caso de transferencia: alta de proveedor
...
### Contraejemplo: acelerar eliminando todos los controles
...
### Reducir lote sin capacidad completa
...
### Aceptar urgencias sin política
...
### Recibir feedback sin autoridad
...
1. El reloj de quien espera puede empezar antes que el trabajo en curso del sistema.

2. Mover el punto de entrada mejora una métrica interna, pero no reduce la demora total.

3. Eficiencia de flujo localiza espera; no identifica por sí sola actividad prescindible.

4. Una transferencia legítima conserva propósito, estado, incertidumbre y próxima acción.

5. Retroalimentación cierra cuando una autoridad modifica una decisión y el efecto vuelve a observarse.
...
1. ¿Dónde comienza y termina una unidad de valor si se adopta la perspectiva de quien espera el resultado?

2. ¿Qué trabajo iniciado permanece invisible para el tablero y qué costo genera mantenerlo abierto?

3. ¿Qué cola concentra la mayor demora y qué política, recurso o autorización la produce?

4. ¿Qué diferencia muestran el tiempo activo y el tiempo total sobre el problema que conviene intervenir?

5. ¿Bajo qué condiciones la Ley de Little permite relacionar trabajo en curso, throughput y tiempo medio sin prometer una predicción individual?

6. ¿Qué espera cumple una función protectora y qué espera sólo refleja lote, handoff o autoridad ausente?
...
**David Anderson.** Convierte límites, políticas explícitas y gestión evolutiva en una práctica observable de flujo.

**Wil van der Aalst.** Desarrolló minería de procesos para reconstruir flujos reales desde registros de eventos.

**Werner Vogels.** Conecta operación distribuida, consistencia y recuperación con compromisos de servicio explícitos.

**Kent Beck.** Vinculó lotes pequeños, pruebas y retroalimentación frecuente en desarrollo de software.

**Amy Edmondson.** Explica cómo voz y seguridad psicológica permiten visibilizar bloqueos y aprender del trabajo real.

**George Box.** Advierte que una medida de flujo es una aproximación cuya utilidad depende de supuestos y finalidad.
