...
Una hipótesis profesional define población, intervención, mecanismo supuesto, resultado, horizonte, salvaguardas y evidencia que obligaría a detener o reformular. También declara explicaciones rivales. La retención puede cambiar por el descuento, por una campaña simultánea, por estacionalidad o por la selección de clientes con mayor propensión inicial. Cada mecanismo exige comparación y evidencia distintas.
...
## Hotel Horizonte: una iniciativa que también puede fracasar
...
Una iniciativa sólo puede aprender de su resultado cuando explicita mecanismo, hipótesis rival, población, línea de base, salvaguardas, umbral y decisión posterior antes de aumentar exposición. Falla si una mejora agregada se usa para validar causalidad, legitimidad y conveniencia al mismo tiempo, en especial cuando oculta daño concentrado. La implicación profesional es conservar separados resultado, interpretación y decisión para poder modificar o retirar la apuesta aunque una métrica favorable invite a escalarla.
...
El núcleo distingue crítica epistemológica, inferencia causal, experimentación de producto y gobierno del daño. Popper fundamenta la posibilidad de refutar; Campbell, Shadish y Pearl ayudan a interpretar resultados; Ries y Blank conectan aprendizaje con decisiones; Box recuerda que todo modelo es una representación limitada; OCDE, NIST, la Unión Europea y W3C delimitan usos que requieren salvaguardas y autoridad.
...
## Movimiento 1 · Convertir la iniciativa en una afirmación refutable
...
## Movimiento 2 · Diseñar evidencia que distinga explicaciones rivales
...
La versión de HH-22 identifica como línea de base las cuatro semanas anteriores a la exposición y mantiene separados turno, canal, tipo de habitación y solicitud de accesibilidad. Conserva para cada segmento cantidad de reservas elegibles, datos faltantes, cancelaciones, espera, reasignaciones y compensaciones. El denominador de cada proporción es la población elegible del mismo segmento, no sólo los casos que completaron el ingreso. Cuando una fuente cambia su definición, la serie se corta y la comparación se declara limitada. Esta especificación permite reconstruir qué observación provino de qué población sin fabricar cifras ausentes.
...
## Movimiento 3 · Detener, ampliar o retirar con salvaguardas
...
### Instrumento HH-22: ficha de hipótesis y decisión
...
1. **Iniciativa.** Nombrar el compromiso propuesto y separar sus actividades del cambio que pretende producir.

2. **Población.** Delimitar quién queda expuesto, quién queda fuera y qué diferencias podrían ocultar los promedios.

3. **Outcome.** Formular la condición observable que debería cambiar, con horizonte y dirección, sin confundirla con un entregable.

4. **Intervención.** Precisar qué acción modifica el sistema y qué partes permanecen constantes para poder interpretar el resultado.

5. **Mecanismo.** Explicar por qué la intervención produciría el outcome y qué paso causal puede observarse antes del resultado final.

6. **Baseline.** Registrar el estado previo con período, fuente, población y variabilidad suficientes para evitar comparaciones retrospectivas convenientes.

7. **Hipótesis rival.** Formular otra explicación plausible, como estacionalidad, selección o cambio operativo concurrente, y prever evidencia que la distinga.

8. **Métricas.** Definir medidas de outcome, mecanismo y protección, con denominadores y segmentos explícitos.

9. **Umbrales.** Fijar antes de observar resultados qué evidencia habilita ampliar, modificar, detener o abandonar la iniciativa.

10. **Salvaguardas.** Establecer límites de exposición, monitoreo, reversión y reparación acordes con el daño posible.

11. **Autoridad.** Identificar quién interpreta evidencia, quién protege a la población y quién puede detener aun cuando el patrocinio quiera continuar.

12. **Decisión y fecha.** Registrar la conclusión provisional, sus límites y el momento o desencadenante de la próxima revisión.
...
En la ficha completada, la hipótesis principal sostiene que confirmar después de verificar asignación, cerradura y condición accesible reduce cancelaciones sin aumentar reasignaciones ni compensaciones. La rival atribuye la mejora a mensajes más claros. La medida de mecanismo observa si los tres estados llegaron antes de la decisión; la de resultado sigue cancelación y tiempo hasta habitación utilizable; la de protección registra toda confirmación corregida, pérdida de accesibilidad y reparación. El umbral de ampliación exige mejora por canal y ausencia de vulneraciones a la salvaguarda. Una sola asignación que desconozca una necesidad accesible detiene esa población, aun cuando no alcance para estimar una tasa estable.

La primera semana queda entonces clasificada con precisión. La hipótesis gana apoyo provisional para reservas directas cuyos estados llegan a tiempo. Pierde apoyo para canales externos, donde aparecen tanto interpretación errónea como demora del dato. La salvaguarda de accesibilidad fue vulnerada en dos episodios y no autoriza ampliar esa población. El equipo conserva cuatro semanas sólo para el segmento directo protegido por revisión humana y abre dos trabajos distintos: corregir semántica y corregir oportunidad del dato. La decisión no declara fracaso universal ni éxito agregado; relaciona evidencia, alcance y acción ejecutable.

### Caso de transferencia: alerta temprana de abandono
...
### Contraejemplo: una hipótesis que no puede perder
...
La prueba exige que iniciativa, población, intervención, mecanismo y outcome formen una proposición que pueda perder apoyo. Baseline, hipótesis rival y métricas se fijan antes de observar el resultado para impedir que cualquier señal posterior parezca éxito.

El escenario adverso mejora la métrica principal mientras empeora una salvaguarda o un subgrupo. HH-22 debe mostrar qué umbral prevalece, quién puede detener y cómo se repara la exposición. Una media favorable no autoriza a ocultar daño asimétrico.

La defensa final presenta una decisión de continuar, adaptar o retirar y conserva la explicación rival. Otra persona debe poder identificar qué evidencia habría llevado a otra conclusión. Si ninguna observación posible cambia el compromiso, la iniciativa no funciona como hipótesis.

La evaluación integral incluye una auditoría de selección. Se comparan casos expuestos, no expuestos, abandonados y corregidos. La ausencia de un registro se trata como una posible consecuencia del sistema y no como cero automático. También se examina si quienes operan la intervención modificaron su conducta porque sabían que estaban siendo observados. Estas amenazas no cancelan toda conclusión, pero limitan su alcance.

Una segunda auditoría reconstruye la cronología. La hipótesis, los umbrales y la autorización deben preceder a la exposición; los datos deben conservar versión y fecha; la interpretación debe preceder a la decisión comunicada. Cuando una pieza fue producida después, el expediente lo declara. La trazabilidad temporal protege contra una historia ordenada retrospectivamente.

La prueba concluye con una decisión proporcional. Evidencia favorable en una población limitada autoriza, como máximo, una ampliación que conserve las condiciones observadas y agregue una incertidumbre identificable. No autoriza despliegue general. Esta regla conecta N22 con N23, donde la hipótesis deberá convertirse en una capacidad de punta a punta y una secuencia de cortes observables.

Una mesa de revisión recibe el expediente sin conocer qué opción prefería el equipo. Debe reconstruir la hipótesis, distinguir medidas de mecanismo y resultado, localizar poblaciones excluidas y reconocer qué umbral produjo la decisión. Si la conclusión sólo resulta convincente cuando quienes ejecutaron la iniciativa completan oralmente los vacíos, la prueba no es todavía auditable.

La mesa formula una hipótesis rival adicional y verifica si los datos conservados permiten examinarla. No se exige anticipar todas las explicaciones, pero sí mantener suficiente procedencia para que una lectura posterior no quede limitada a la narrativa inicial. En HH-22, segmentar por turno y canal permite descubrir que una parte de la mejora coincide con mayor dotación. Esta observación reduce la fuerza de la atribución y cambia el próximo corte.

Finalmente se revisa la economía de la prueba. Instrumentar, supervisar y reparar también consume capacidad. Un experimento puede ser metodológicamente atractivo y producir menos información decisional que una reconstrucción de episodios o una intervención manual. Elegir el diseño implica comparar valor esperado de información, costo y exposición, sin convertir mayor sofisticación estadística en sinónimo de rigor profesional.
...
### Elegir métricas después del resultado
...
1. Una iniciativa gobernable puede perder apoyo y tiene una decisión preparada para ese resultado.

2. Asociación, explicación causal, límite normativo y decisión son juicios distintos.

3. Una métrica sin población, denominador y ventana permite cambiar el relato después de observar.

4. Vulnerar una salvaguarda puede detener exposición aunque la hipótesis conserve apoyo parcial.

5. Refutado, debilitado, inconcluso y no autorizado para ampliar no significan lo mismo.
...
1. ¿Cómo se formula una iniciativa para que pueda fracasar por algo distinto de no completar sus entregables?

2. ¿Qué outcome del episodio pertenece a una población concreta y cuál sería sólo una señal de actividad?

3. ¿Qué mecanismo conecta la intervención con el resultado y qué indicador temprano permitiría observarlo?

4. ¿Qué umbral obligaría de verdad a detener o rediseñar la iniciativa?

5. ¿Qué período, población y variabilidad necesita la baseline para evitar una comparación conveniente?

6. ¿Qué explicación rival podría producir la misma mejora y cómo se distinguiría sin ampliar daño?
...
**Karl Popper.** Formuló la refutación como criterio de crítica del conocimiento.

**Judea Pearl.** Formalizó modelos causales que distinguen observación, intervención y atribución.

**Eric Ries.** Popularizó ciclos de construir, medir y aprender para reducir incertidumbre.

**Steve Blank.** Vinculó descubrimiento de clientes con hipótesis sobre problemas, propuestas y modelos que deben contrastarse.

**George Box.** Mostró que los modelos son aproximaciones cuya utilidad depende de propósito, supuestos y contraste.

**Elham Tabassi.** Lideró un marco para gobernar, medir y gestionar riesgos de inteligencia artificial.
...
- OCDE (2021). *Recommendation of the Council on Enhancing Access to and Sharing of Data*. https://legalinstruments.oecd.org/en/instruments/OECD-LEGAL-0463
...
- W3C (2024). *Ethical Web Principles*. https://www.w3.org/TR/ethical-web-principles/
