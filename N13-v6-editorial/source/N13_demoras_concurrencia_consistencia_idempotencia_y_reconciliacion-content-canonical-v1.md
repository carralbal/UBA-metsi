...
**Barbara Liskov.** Formalizó condiciones de sustitución y abstracción que permiten razonar sobre garantías conservadas entre componentes.

**Werner Vogels.** Sistematizó implicaciones prácticas y experiencia observable de la consistencia eventual.

**David Parnas.** Mostró cómo localizar decisiones de diseño para que un cambio no propague consecuencias innecesarias.

**Leonard Kleinrock.** Desarrolló fundamentos de teoría de colas para relacionar carga, espera, servicio y capacidad.
...
- Liskov, B. H. y Wing, J. M. (1994). “A Behavioral Notion of Subtyping”. *ACM Transactions on Programming Languages and Systems*, 16(6), 1811–1841. https://doi.org/10.1145/197320.197383
...
- Ross, R., McEvilley, M. y Winstead, M. (2022). *Engineering Trustworthy Secure Systems*. NIST SP 800-160 Vol. 1 Rev. 1. https://doi.org/10.6028/NIST.SP.800-160v1r1
