...
N03 quedó sincronizado con su contenido canónico final, compuesto y auditado. La fuente histórica v7 y sus artefactos de 34 páginas no forman parte de esta entrega. El PDF v9 es un artefacto nuevo generado desde la fuente canónica y no una copia renombrada. Su nombre y su ruta son distintos de v8 para impedir que el visor conserve una portada anterior en caché.
...
- Auditoría: `validation-v9.json`, `qa-report.json`, `integrity-report.json`, `qa/N03-contact-sheet.jpg`, `visual-audit.md`
...
- PDF SHA256: `5b0d2f0efb950f7d95f19b2bbb50c697b5f33901623c8a56ab6b768f8dfa9a15`.
