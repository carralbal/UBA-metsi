...
Sin embargo, todavía no sabemos qué fenómeno debe cambiar. Puede que el PMS sea lento, pero también que la latencia percibida surja cuando una reserva no tiene garantía, cuando el inventario de una OTA llega tarde, cuando recepción espera confirmación de housekeeping o cuando las categorías de habitación no significan lo mismo en todos los canales.

Una aplicación podría disminuir preguntas simples o agregar otro lugar donde el huésped recibe una promesa incompatible. Un chatbot podría resolver consultas o ejecutar cancelaciones equivocadas con gran velocidad.
...
La octava edición del PMBOK Guide consolida los doce principios de la séptima en seis y refina los dominios de desempeño de ocho a siete. También reintroduce los grupos de procesos como Áreas de Foco e integra cuarenta procesos no prescriptivos dentro de los dominios, en lugar de convertirlos en una secuencia obligatoria. ISO/IEC/IEEE 24748-1:2024 trata asimismo la adaptación del ciclo de vida como una decisión situada.

Ambos aportes son útiles si el equipo puede explicar qué función conserva al adaptar; usados como listas de cumplimiento, pueden producir exactamente la rigidez que intentan evitar.
...
Hotel Horizonte decide entrevistar a seis personas de Recepción. La actividad, observada desde afuera, parece rigurosa: existe una guía, se registran respuestas y luego se redacta un informe. Sin embargo, el equipo ya resolvió comprar un nuevo PMS y formula preguntas destinadas a confirmar esa elección: qué pantallas resultan lentas, qué funciones faltan y qué errores recuerdan quienes atienden.

Las entrevistas producen información real, pero el propósito de la práctica es retrospectivo: legitimar una solución que ya no puede ser modificada. Si alguien relata que el problema aparece antes de tocar el PMS (por ejemplo, cuando Comercial promete un check-in temprano sin consultar capacidad operativa), el dato queda clasificado como “fuera de alcance”.

La actividad fue ejecutada correctamente y, aun así, su calidad metodológica es baja porque incumple el criterio de revisabilidad.

Imaginemos ahora las mismas seis entrevistas con una frase previa distinta: “las realizamos para distinguir si la demora dominante nace en la interfaz, en la propagación de estados o en la coordinación entre áreas; si aparecen mecanismos diferentes, revisaremos el alcance de la intervención”. Las preguntas reconstruyen episodios concretos, separan observación de interpretación y preguntan qué ocurrió antes y después de cada excepción.

El equipo contrasta los relatos con registros y acuerda de antemano qué hallazgo sostendría cada explicación. La técnica no cambió: sigue siendo una entrevista. Cambiaron su propósito, la posibilidad de contradicción y el vínculo entre evidencia y decisión.
...
El pedido inicial puede transformarse en un encargo de intervención provisional. Esa primera transformación queda registrada como **HH-01**, el memo metodológico de Hotel Horizonte. Su función no es diagnosticar el hotel ni anticipar la solución. Debe conservar el pedido recibido, el propósito que podría justificar una intervención, las incertidumbres que impiden comprometer una respuesta, la evidencia inicial, la próxima acción autorizada y la condición capaz de revisar el camino.
...
HH-01 puede cerrarse con una declaración breve: **“Se autoriza reconstruir episodios de reserva y llegada durante dos semanas para distinguir problemas de aplicación, información, coordinación y promesa. No se autoriza todavía seleccionar plataforma ni atribuir las sobreventas al PMS. El memo se revisará si los episodios muestran que la falla dominante ocurre fuera de la frontera inicialmente observada”**. La declaración convierte la revisabilidad en una regla operativa y deja preparada la pregunta que N02 deberá responder.

El memo contiene siete campos: pedido recibido, propósito, incertidumbres, evidencia disponible, acción autorizada, decisión todavía no autorizada y condición de revisión. No sustituye los artefactos posteriores. Entrega a N02 una situación y una obligación metodológica: construir el sistema relevante antes de decidir qué componente explica la promesa incumplida.
...
1. Una metodología rigurosa vuelve visible el juicio y aplica el criterio de revisabilidad.
2. Ejecutar bien una receta no corrige haber construido mal el problema.
3. Cada práctica debe reducir una incertidumbre antes de una decisión concreta.
4. Adaptar con rigor es conservar funciones; improvisar es cambiar sin dejar trazabilidad.
5. Cuanto más autónoma es una tecnología, más explícitos deben ser sus límites, autoridad y reparación.

## Glosario esencial

- **Método, metodología, marco, práctica, técnica y herramienta:** ver la sección 07, que distingue sus funciones y relaciones.
- **Frontera:** recorte que define qué relaciones integran el sistema analizado y cuáles quedan en su entorno sin perder relevancia causal.
- **Situación problemática:** configuración de interpretaciones, intereses y relaciones que todavía no admite una definición única del problema.
- **Evidencia suficiente:** evidencia capaz de reducir la incertidumbre en proporción al impacto y la reversibilidad de la decisión.
- **Incertidumbre epistemológica:** falta de comprensión sobre qué ocurre, por qué ocurre o con qué alcance puede afirmarse.
- **Incertidumbre de acción:** duda sobre qué alternativa producirá el outcome buscado aun cuando la situación se comprende razonablemente.
- **Incertidumbre de coordinación:** duda sobre la capacidad de sostener una alternativa mediante responsabilidades, contratos y mecanismos de escalamiento.
- **Incertidumbre normativa:** cuestión abierta sobre qué debe permitirse, con qué autoridad y quién responde por las consecuencias.
- **Criterio de revisabilidad:** exigencia de declarar qué evidencia adversa podría cambiar una explicación, un alcance o una decisión.
...
3. ¿Qué permite distinguir una adaptación rigurosa de una improvisación conveniente?
...
7. ¿Qué outcome haría que el sistema de turnos mejore el acceso en lugar de reforzar una barrera previa?

Para el encuentro, traer respondidas por escrito dos de las siete preguntas y completar una ficha breve de HH-01. La ficha debe distinguir pedido, propósito, incertidumbre, evidencia, acción autorizada, decisión todavía no autorizada y condición de revisión. Señalar además cuál pregunta resulta más difícil de responder y por qué: ambas producciones alimentan la puesta en común.

## Referencias base

- Checkland, P., y Poulter, J. (2007). *Learning for Action: A Short Definitive Account of Soft Systems Methodology and its Use for Practitioners, Teachers and Students*. Wiley. ISBN 978-0-470-02554-3.
