...
La etapa posterior a la colección editorial comenzó en `pedagogy/`. El plan maestro define preparación asincrónica, taller sincrónico, guion docente y rúbrica para cada N. Los bloques A y B, N01 a N10, ya cuentan con paquetes ejecutables y auditables. Funcionan como referencia de profundidad, no como plantillas mecánicas de dinámica.
