# N01 · Metodología sin recetas: intervenir cuando el problema todavía no está claro
...
Un equipo de rescate entra en una zona montañosa cubierta por niebla. Lleva un mapa detallado, una ruta marcada, tiempos estimados y responsabilidades claras. Cada integrante sabe qué debe hacer. El grupo avanza con disciplina y celebra que todos los hitos se cumplen. Horas después descubre que el mapa corresponde a otro valle. La ejecución fue impecable; la orientación, incorrecta.

La escena parece exagerada, pero describe un riesgo cotidiano de los sistemas de información. Una organización puede relevar requisitos, producir diagramas, completar sprints, aprobar pruebas y desplegar en fecha mientras conserva una definición equivocada del problema. El movimiento visible crea confianza. La calidad de los entregables puede ocultar que nadie comprobó si el mapa representa el territorio.

La salida no consiste en caminar sin mapa. Consiste en tratarlo como una hipótesis: verificar señales del terreno, comparar relatos, reconocer lo que queda fuera y acordar qué hallazgo obligaría a corregir la ruta. Una metodología profesional sirve precisamente para eso. No promete que el primer encuadre será correcto; organiza la posibilidad de descubrir el error antes de que avanzar resulte irreversible.
...
Eso es metodología en acción. No es una ceremonia adicional ni una forma elegante de demorar. Es la capacidad de relacionar una anomalía con una pregunta y esa pregunta con una decisión. La marca en la roca puede ser ruido; el relato local puede estar equivocado; el altímetro puede fallar. El rigor no consiste en creer ciegamente una señal, sino en diseñar una comprobación proporcional al riesgo de continuar por el valle incorrecto.
...
La historia deja una idea que recorrerá toda la materia: avanzar no siempre significa aprender. Un equipo aprende cuando la evidencia puede cambiar su explicación, su alcance o su próxima decisión. Si ningún hallazgo puede modificar el camino, el mapa ya no orienta; gobierna. Y una metodología que no admite ser corregida ha dejado de ser metodología para convertirse en obediencia.

## Tesis

Una metodología profesional no sustituye el juicio. Organiza el modo en que un equipo formula preguntas, produce y cuestiona evidencia, hace visibles supuestos, coordina decisiones, limita riesgos y aprende. Su rigor no depende de repetir una secuencia universal, sino de conservar una relación defendible entre contexto, propósito, prácticas elegidas, evidencia obtenida y decisiones revisables.

## La tranquilidad de empezar por una solución

La dirección de Hotel Horizonte envía un pedido que parece concreto: reemplazar el PMS, lanzar una aplicación para huéspedes e incorporar un chatbot con inteligencia artificial. Hay presupuesto preliminar, urgencia comercial y una lista de problemas conocidos. La tentación profesional es responder con un plan: relevamiento, requisitos, selección de proveedor, implementación, pruebas y despliegue. El plan produce una sensación inmediata de avance. Ya hay actividades, responsables y entregables.
...
El pedido contiene problemas posibles, soluciones preferidas, restricciones políticas y una narrativa sobre el futuro. No contiene todavía un problema investigado. Empezar por la solución no es un pecado técnico: a veces la restricción existe y no puede discutirse. El error consiste en tratarla como si demostrara qué causa la situación, qué outcome importa y qué intervención será efectiva.
...
Quien estudió Ingeniería de Software ya posee una base importante. Sabe que construir software exige comprender necesidades, modelar, diseñar, verificar, gestionar cambios y conservar trazabilidad. Aprendió que una solución no termina cuando compila y que la calidad incluye atributos como seguridad, mantenibilidad, rendimiento y usabilidad. También conoce la diferencia entre una idea informal y una especificación que otro equipo puede implementar y probar.
...
El avance no consiste en acumular técnicas. Consiste en cambiar la calidad de la decisión. Al terminar N01, alcanza con poder reconocer que un pedido todavía no es un problema investigado. Al terminar N10, el estudiante debe poder defender qué situación interviene, qué queda fuera, qué explicaciones compiten, qué evidencia falta, qué cambio importa y cuándo será necesario reformular todo el encuadre.

Este mapa también fija una disciplina para evitar repeticiones. N01 conserva la pregunta metodológica general. Los números siguientes profundizan un mecanismo particular y devuelven una consecuencia nueva. Cuando una noción reaparece, no vuelve para definirse otra vez, sino para producir una inferencia que antes no podía sostenerse. El cierre de esta lectura prepara así la transición inmediata hacia N02: antes de elegir cómo intervenir, hay que determinar qué sistema estamos mirando.

## Planificar no es predecir

Existe una crítica superficial a la planificación: como el futuro cambia, planificar sería inútil. Esa conclusión confunde plan con predicción exacta. Un buen plan expresa una hipótesis coordinada sobre acciones, dependencias, evidencia y decisiones. Sirve para detectar desvíos, no para negar su existencia.

El PMBOK Guide, octava edición, conserva principios y dominios de desempeño, pero recupera orientación de procesos de manera explícitamente adaptable. ISO/IEC/IEEE 24748-1:2024 también trata la adaptación del ciclo de vida como una decisión situada. Ambos aportes son útiles si el equipo puede explicar qué función conserva al adaptar; usados como listas de cumplimiento, pueden producir exactamente la rigidez que intentan evitar.
...
- trabajo conocido y descubrimiento pendiente;
- hitos de producción e hitos de decisión;
- dependencia técnica y dependencia organizacional;
- compromiso reversible e irreversible;
- estimación y promesa;
- objetivo y pronóstico;
- buffer de riesgo y tiempo libre sin propósito.
...
La rigidez repite prácticas aunque el contexto cambie. La improvisación cambia prácticas sin conservar propósito, evidencia ni consecuencias. El rigor adaptativo se ubica entre ambas.
...
1. qué pregunta se intentaba responder;
2. qué evidencia estaba disponible;
3. qué supuestos se aceptaron;
4. qué alternativas se consideraron;
5. por qué se eligió una práctica o decisión;
6. qué resultado se observó;
7. qué cambió después.
...
La calidad metodológica no se observa, por tanto, en la cantidad de reuniones o documentos. Se observa en la capacidad del dispositivo para detectar que estaba equivocado antes de que el costo sea irreversible. Un equipo puede ejecutar impecablemente un proceso y aprender muy poco si cada práctica confirma decisiones tomadas de antemano. Otro puede usar pocos artefactos y sostener un aprendizaje riguroso si relaciona cada uno con una incertidumbre, conserva evidencia adversa y establece condiciones explícitas de revisión.
...
Decidir con rigor no equivale a esperar certeza. La evidencia es suficiente cuando reduce la incertidumbre hasta un nivel proporcionado a la decisión, el impacto y la reversibilidad. Una modificación local que puede revertirse en horas admite una base menor que una migración irreversible de datos, una automatización que afecta derechos o un cambio contractual de largo plazo.
...
## Tailoring: adaptar sin perder la lógica

Adaptar una metodología no consiste en elegir las ceremonias que resultan cómodas. Consiste en conservar funciones necesarias mediante prácticas proporcionadas. Si un contexto exige evidencia de aprobación, puede cambiar el formato documental, pero no desaparecer la capacidad de reconstruir quién autorizó qué. Si la incertidumbre es alta, puede reducirse el tamaño del plan, pero no la obligación de formular hipótesis y observar resultados.
...
## El costo de no intervenir y el costo de aprender
...
El aprendizaje tampoco es gratuito. Entrevistar exige tiempo y confianza; un piloto expone usuarios; instrumentar telemetría puede afectar privacidad; mantener opciones abiertas tiene costo de coordinación. La pregunta metodológica no es si aprender siempre es bueno, sino qué aprendizaje vale su costo y qué decisión concreta podrá cambiar.
...
## Tres usos defectuosos de la metodología
...
Reconocer estos patrones es difícil porque pueden producir entregables impecables. El indicador no es la forma, sino si una evidencia adversa puede cambiar la decisión.

## 2026: cuando el método también debe gobernar agentes

En 2026, una herramienta generativa ya no se limita a sugerir texto. Puede consultar fuentes, escribir código, invocar servicios, actualizar registros y encadenar acciones. Esa capacidad modifica el problema metodológico. Cuando una salida de inteligencia artificial se convierte en una acción, la calidad no depende solamente de la respuesta: depende de qué contexto recibió el agente, qué herramientas puede usar, qué autoridad posee, qué evidencia conserva y quién puede detenerlo o reparar una consecuencia.
...
También cambia el trabajo de los equipos. Un asistente puede producir entrevistas sintéticas, requisitos, diagramas y planes en minutos. La velocidad amplifica tanto una buena pregunta como una mala. Por eso la autoría profesional no consiste en aceptar o rechazar inteligencia artificial como bloque. Consiste en poder reconstruir qué afirmaciones provienen de evidencia, cuáles fueron inferidas, qué decisiones siguen siendo humanas y qué controles vuelven responsable la delegación.
...
Los marcos actuales ayudan, pero no reemplazan el juicio situado. El Reglamento de Inteligencia Artificial de la Unión Europea exige obligaciones diferentes según el riesgo y el rol de cada actor. Los estándares de ciclo de vida recuerdan que un sistema debe pensarse desde su concepción hasta su retiro. Ninguno de estos aportes decide automáticamente qué debe hacer Hotel Horizonte. Su valor aparece cuando el equipo los traduce en preguntas, evidencia, responsables y condiciones de salida adecuadas al caso.

Hay además una novedad pedagógica. En 2026, una persona estudiante puede pedirle a un asistente que produzca un mapa, una entrevista simulada, una lista de requisitos o un análisis de riesgo en segundos. Eso reduce el costo de generar artefactos, pero no garantiza su relación con el problema. La competencia central se desplaza: ya no alcanza con saber producir un documento; hay que saber interrogar su procedencia, detectar supuestos, contrastar evidencia y explicar qué decisión permite tomar. La abundancia de respuestas vuelve más valiosa la calidad de las preguntas.
...
- reconstruir episodios completos de sobreventa, check-in demorado y cambio de habitación;
- observar trabajo de recepción y housekeeping en momentos críticos;
- identificar estados, eventos y autoridades entre PMS, canales, planillas y prácticas informales;
- revisar contratos y tiempos de sincronización con OTAs;
- diferenciar consultas informativas, decisiones comerciales y acciones que requieren identidad o autorización;
- definir outcomes que no se reduzcan a velocidad o autoservicio.

El resultado de esas acciones puede llevar a soluciones distintas: modificar una regla de inventario, crear un control de transición, redefinir responsabilidades, integrar estados, rediseñar una promesa, mejorar datos de accesibilidad, reemplazar un componente o, efectivamente, adquirir una plataforma nueva.
...
La metodología permite distinguir tarea, outcome y autoridad. El problema no es “cómo predecir mejor”, sino qué intervención mejora acceso sin castigar a quien enfrenta una barrera. La técnica de modelado puede ser útil, pero solo después de construir esa pregunta.
...
- resistir una solución prematura sin paralizar la organización;
- formular un compromiso de aprendizaje concreto;
- seleccionar prácticas proporcionales al riesgo;
- hacer visibles supuestos y autoridades;
- integrar dimensiones técnicas, organizacionales y humanas;
- mostrar qué evidencia sostiene una decisión;
- cambiar de enfoque sin perder trazabilidad;
- reconocer cuándo una intervención metodológica produce daño o teatro.
...
No toda organización permite discutir el pedido. Puede existir una compra ya firmada, una obligación regulatoria o una fecha irreversible. La metodología sigue siendo útil: cambia la pregunta desde “qué solución elegir” a “cómo integrar, limitar riesgo, medir efecto y preparar contingencia”.
...
Finalmente, la trazabilidad puede degenerar en burocracia. El criterio es conservar aquello que permite decidir, coordinar, explicar, auditar o aprender. Documentar por temor no es rigor; no documentar porque el equipo “ya sabe” crea dependencia y amnesia.
...
- Una metodología no reemplaza el juicio: lo vuelve visible, discutible y revisable.
- Ejecutar bien una receta no corrige haber construido mal el problema.
- Cada práctica debe reducir una incertidumbre antes de una decisión concreta.
- Adaptar con rigor es conservar funciones; improvisar es cambiar sin dejar trazabilidad.
- Cuanto más autónoma es una tecnología, más explícitos deben ser sus límites, autoridad y reparación.

## Glosario esencial

- **Método:** forma organizada de proceder para alcanzar un propósito determinado.
- **Metodología:** razonamiento mediante el cual se seleccionan, combinan, justifican y revisan métodos.
- **Marco:** conjunto de conceptos, roles o dimensiones que ordena una mirada sin resolver por sí solo cómo actuar.
- **Práctica:** actividad recurrente y socialmente reconocible realizada por un equipo.
- **Técnica:** procedimiento acotado aplicado dentro de una práctica.
- **Herramienta:** soporte material o digital que amplifica una capacidad sin contener el criterio profesional para usarla.
- **Tailoring:** adaptación deliberada de una metodología para conservar sus funciones con una intensidad proporcionada al contexto.
- **Outcome:** cambio observable en una situación, una capacidad o una experiencia; no es sinónimo de producto entregado.
- **Hito de decisión:** momento acordado para interpretar evidencia y decidir si se continúa, modifica, detiene o amplía una intervención.
- **Trazabilidad:** capacidad de reconstruir preguntas, evidencia, supuestos, alternativas y decisiones.
- **Reversibilidad:** posibilidad técnica y organizacional de deshacer una acción o limitar sus consecuencias.
- **Agente de inteligencia artificial:** sistema capaz de perseguir un propósito mediante una secuencia de decisiones y uso de herramientas dentro de permisos definidos.

## Preguntas de preparación

1. ¿Qué puede prometer razonablemente una metodología y qué promesa sería engañosa?
2. ¿Qué decisiones del pedido de Hotel Horizonte son prematuras y cuáles funcionan como restricciones reales?
3. ¿Cómo distinguiría una adaptación rigurosa de una improvisación conveniente?
4. ¿Qué evidencia podría hacer que un equipo abandone la idea de reemplazar el PMS?
5. ¿Cuándo investigar más deja de ser prudente y se convierte en una forma de evitar decidir?
6. ¿Qué actores pierden voz cuando la metodología se organiza solo alrededor del patrocinador?

## Referencias base

- Checkland, P., y Poulter, J. (2007). *Learning for Action: A Short Definitive Account of Soft Systems Methodology and its Use for Practitioners, Teachers and Students*. Wiley. https://www.wiley.com/en-us/Learning+For+Action%3A+A+Short+Definitive+Account+of+Soft+Systems+Methodology%2C+and+its+use+for+Practitioners%2C+Teachers+and+Students-p-9780470025543
- Schön, D. A. (1983). *The Reflective Practitioner: How Professionals Think in Action*. Basic Books.
- Argyris, C., y Schön, D. A. (1996). *Organizational Learning II: Theory, Method, and Practice*. Addison-Wesley.
- March, J. G. (1991). “Exploration and Exploitation in Organizational Learning”. *Organization Science*, 2(1), 71 a 87. https://doi.org/10.1287/orsc.2.1.71
- Suchman, L. (2007). *Human-Machine Reconfigurations: Plans and Situated Actions*. Cambridge University Press. https://doi.org/10.1017/CBO9780511625510
- Senge, P. M. (2006). *The Fifth Discipline: The Art and Practice of the Learning Organization*. Revised edition. Currency.
- ISO/IEC/IEEE (2024). *ISO/IEC/IEEE 24748-1:2024, Systems and software engineering: Life cycle management, Part 1: Guidelines for life cycle management*. https://www.iso.org/standard/84709.html
- Project Management Institute (2025). *A Guide to the Project Management Body of Knowledge, PMBOK Guide, Eighth Edition*. https://www.pmi.org/standards/pmbok
- Tabassi, E. (2023). *Artificial Intelligence Risk Management Framework, AI RMF 1.0*. NIST AI 100-1. National Institute of Standards and Technology. https://doi.org/10.6028/NIST.AI.100-1
- Autio, C., Schwartz, R., Dunietz, J., Jain, S., Stanley, M., Tabassi, E., Hall, P., y Roberts, K. (2024). *Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile*. NIST AI 600-1. https://doi.org/10.6028/NIST.AI.600-1
- Washizaki, H. (Ed.). (2025). *Guide to the Software Engineering Body of Knowledge, SWEBOK Guide, Version 4.0a*. IEEE Computer Society. https://www.computer.org/education/bodies-of-knowledge/software-engineering
...
- Parlamento Europeo y Consejo de la Unión Europea (2024). *Reglamento (UE) 2024/1689 por el que se establecen normas armonizadas en materia de inteligencia artificial*. https://eur-lex.europa.eu/eli/reg/2024/1689/oj
- DORA (2025). *State of AI-assisted Software Development*. Google Cloud. https://dora.dev/research/2025/dora-report/
- ACM y AIS (2020). *IS2020: A Competency Model for Undergraduate Programs in Information Systems*. https://is2020.hosting2.acm.org/wp-content/uploads/2021/06/is2020.pdf
