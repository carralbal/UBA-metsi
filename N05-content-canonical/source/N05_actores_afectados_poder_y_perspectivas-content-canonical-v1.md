# N05 · Actores, afectados, poder y perspectivas

<!-- N05-CONTENT-CONTRACT: canonical-final; content-only; no-layout -->
...
La nueva parada quedaba a diecisiete minutos a pie, por una zona sin iluminación. Dos días después, un estudiante que usaba silla de ruedas descubrió que el refugio elegido tenía un desnivel imposible de atravesar sin ayuda. La aplicación mostraba la parada como accesible porque el vehículo tenía rampa; nadie había registrado la vereda.

Ambos problemas podían describirse como “casos particulares”. Ninguno afectaba demasiado el promedio. Tampoco eran defectos del software de planificación: el algoritmo había optimizado correctamente las variables que recibió. El problema estaba antes. El modelo no había incorporado el horario real de quienes salían de limpiar edificios ni la continuidad física entre vehículo, refugio y vereda.

Las personas afectadas no habían faltado a una reunión sobre una solución ya definida: habían faltado en el momento en que se decidió qué contaba como demanda, qué significaba accesibilidad y qué costos podían quedar fuera.
...
El rediseño mejoró cuando el equipo dejó de preguntar “¿a quiénes consultamos?” y pasó a formular seis preguntas: ¿quién define el propósito?, ¿quién conoce las variaciones del trabajo?, ¿quién autoriza el cambio?, ¿quién puede impedirlo o desviarlo?, ¿quién recibe beneficios o daños?, ¿quién puede reparar si la intervención falla? La trabajadora nocturna no necesitaba decidir la arquitectura del sistema. Sí necesitaba poder modificar la definición de acceso.

El estudiante no debía estimar costos. Sí debía participar de la prueba del recorrido completo. Los conductores no representaban automáticamente a pasajeros, limpiadores o personas con movilidad reducida. La organización de accesibilidad tampoco podía hablar por todas ellas sin contrastar episodios concretos.
...
Un mapa de actores no es una lista de personas dibujada alrededor de una solución. Es una representación provisional de sus relaciones con una decisión: quién aporta conocimiento, quién controla recursos o significados, quién autoriza, quién ejecuta, quién depende del sistema, quién recibe beneficios o daños, quién puede objetar y quién puede reparar. Su calidad no depende de la cantidad de nombres, sino de las diferencias que hace visibles y de las decisiones que obliga a revisar.

Las perspectivas no deben promediarse demasiado pronto. Una contradicción entre Dirección, Operaciones, Tecnología y las personas afectadas puede mostrar que usan fronteras, tiempos, definiciones o criterios de éxito diferentes. El trabajo metodológico consiste en conservar esa tensión el tiempo necesario para producir evidencia y acordar cómo se decidirá. Cuando una intervención borra la diferencia demasiado pronto, el consenso puede ser apenas una forma amable de esconder una desigualdad de poder.
...
Considérese un requisito aparentemente preciso: “El huésped podrá completar el check-in desde su teléfono antes de llegar”. Ingeniería de Software ayuda a definir autenticación, validaciones, integraciones, estados y criterios de aceptación.

N05 pregunta además: ¿quién convierte documentos analógicos en datos?, ¿qué ocurre con una persona sin teléfono compatible?, ¿quién decide que una discrepancia exige presencia?, ¿qué trabajo nuevo recibe Recepción?, ¿quién puede corregir una identidad mal asociada?, ¿qué actor queda expuesto si la automatización confirma una habitación aún no disponible? El requisito no desaparece; cambia su contexto de justificación.
...
Un **proveedor** controla una capacidad bajo contrato. Un **responsable** debe rendir cuentas por una decisión o resultado. Un **regulador o garante** establece límites, derechos y evidencia exigible.
...
Pueden distinguirse siete fuentes de poder. El **poder formal** proviene de cargos, normas o derechos. El **poder de recursos** controla presupuesto, infraestructura, datos o tiempo. El **poder experto** depende de conocimiento difícil de sustituir. El **poder informacional** selecciona qué señales llegan a la decisión y cómo se clasifican. El **poder de implementación** aparece cuando alguien puede ejecutar, adaptar, demorar o bloquear en la práctica.

El **poder de salida** pertenece a quien puede abandonar la relación sin sufrir un costo excesivo. El **poder de encuadre** define qué problema se discute, qué alternativas parecen razonables y qué consecuencias se consideran externas.
...
No existe un único nivel correcto de participación. La escala de Arnstein permite advertir que informar, consultar y transferir poder no son equivalentes. El diseño sociotécnico participativo de Mumford y la justicia de diseño de Costanza-Chock agregan dos exigencias: la participación debe incidir en las alternativas y debe partir de quienes viven las consecuencias, no sólo de quienes patrocinan la intervención.

Informar, consultar, observar, codiseñar, decidir conjuntamente, habilitar veto o establecer supervisión responden a situaciones distintas. El error consiste en elegir el nivel por comodidad y llamarlo participación suficiente sin relacionarlo con la decisión y el riesgo.
...
Jorge Etkin y Leonardo Schvarstein muestran que una organización conserva rasgos de identidad mientras cambia estructuras, tecnologías y prácticas. Esa identidad no es un eslogan: aparece en relaciones, criterios de pertenencia, autonomía y modos de procesar contradicciones. En Hotel Horizonte, reemplazar un canal o automatizar una decisión puede alterar quién interpreta una excepción y quién responde por la promesa, aunque el organigrama permanezca igual. El mapa de actores debe observar esa transformación y no suponer que los roles escritos conservan automáticamente capacidad real.

Paola Ricaurte agrega que datos y plataformas también distribuyen poder epistémico. Las categorías con las que un sistema clasifica personas definen qué experiencia puede hacerse visible, quién queda como caso normal y qué saber se considera válido. Incorporar participación no alcanza si la infraestructura continúa imponiendo vocabularios, datos y criterios producidos desde otro contexto. HH-05 pregunta quién define las categorías, qué poblaciones no pueden representarse y qué capacidad existe para disputar una clasificación antes de que se convierta en decisión.
...
#### Paso 1. Escribir la decisión en forma operativa
...
#### Paso 2. Identificar el resultado esperado y la promesa
...
#### Paso 3. Reconstruir actores por relación, no por área
...
#### Paso 4. Mapear canales de poder
...
#### Paso 5. Relacionar afirmaciones con fuentes
...
#### Paso 6. Analizar beneficio, daño y reparación
...
#### Paso 7. Elegir una estrategia de participación
...
#### Paso 8. Definir gobierno y condición de revisión
...
La automatización también cambia autoridad epistémica. Una recomendación adquiere peso por su apariencia cuantitativa o por la fluidez de su lenguaje. La persona conserva formalmente la decisión, pero puede carecer de tiempo, información o respaldo para contradecirla. El Reglamento europeo de IA exige supervisión humana efectiva en sistemas de alto riesgo.

El marco de gestión de riesgos de IA de NIST vincula gobierno con responsabilidades, diversidad disciplinar y participación de comunidades afectadas. La idea común es práctica: la supervisión debe ser competente, informada y capaz de intervenir, no una firma humana al final.
...
#### Episodio HH-05: una llegada que nadie podía autorizar
...
### Caso de transferencia: crédito para pequeños comercios
...
1. **Estar afectado no garantiza tener voz.**
2. **Tener conocimiento no equivale a tener autoridad.**
3. **La ausencia de conflicto puede ser una señal de exclusión.**
4. **Automatizar una tarea también redistribuye carga y poder.**
5. **Toda decisión debe declarar quién puede objetar y quién repara.**

## Glosario esencial

- **Actor:** persona, grupo u organización que participa, influye o queda expuesto a consecuencias.
- **Stakeholder:** parte interesada; término amplio que debe desagregarse por relación con una decisión.
- **Afectado:** actor que recibe beneficios, cargas o daños aunque no use el sistema.
- **Autoridad:** capacidad legítima de aprobar, detener o modificar una decisión.
- **Capacidad:** posibilidad real de ejecutar, supervisar o reparar, más allá del rol formal.
- **Voz:** posibilidad efectiva de aportar evidencia, cuestionar y producir influencia.
- **Conocimiento situado:** saber construido desde una posición y experiencia concretas.
- **Poder de encuadre:** capacidad de definir qué problema, alternativas y consecuencias entran en discusión.
- **Injusticia epistémica:** pérdida de credibilidad o de recursos interpretativos que impide que una experiencia sea reconocida como conocimiento.
- **Trabajo oculto:** actividad necesaria que no aparece en procesos, métricas o reconocimiento formal.
- **Participación significativa:** intervención cuyo alcance, momento e influencia potencial están declarados y reciben devolución.
- **Objeción:** mecanismo mediante el cual una persona puede cuestionar una decisión o su fundamento.
- **Reparación:** acción que corrige o compensa una consecuencia adversa, restaura capacidad y asigna responsabilidad.
- **Mapa ADC:** mapa Actor, Decisión, Consecuencia que vincula actores, poder, conocimiento, afectación y gobierno con una decisión concreta.
- **Supervisión humana efectiva:** capacidad informada y respaldada de comprender límites, desviarse, detener, escalar y reparar una decisión automatizada.
- **OTA:** agencia de viajes en línea que comercializa reservas e introduce reglas, contratos y tiempos propios.
- **PMS:** sistema de gestión hotelera que administra reservas, habitaciones, tarifas y parte de la operación.

## Preguntas de preparación

1. ¿Quién decide una promesa en Hotel Horizonte y quién da la cara cuando falla?
2. ¿Qué actor posee conocimiento crítico pero poca autoridad?
3. ¿Qué diferencia existe entre invitar, consultar, codiseñar y otorgar capacidad de detención?
4. ¿Qué afectado no aparece en el organigrama ni en la analítica digital?
5. ¿Qué mecanismo concreto produce el poder de una OTA o de un proveedor de IA?
6. ¿Qué condiciones convierten a la supervisión humana en efectiva y no nominal?
...
- Star, S. L. y Strauss, A. (1999). “Layers of Silence, Arenas of Voice: The Ecology of Visible and Invisible Work”. *Computer Supported Cooperative Work*, 8, 9-30. https://doi.org/10.1023/A:1008651105359
...
- Suresh, H., Tseng, E., Young, M., Gray, M. L., Pierson, E. y Levy, K. (2024). “Participation in the Age of Foundation Models”. *Proceedings of the 2024 ACM Conference on Fairness, Accountability, and Transparency*, 1609-1621. https://doi.org/10.1145/3630106.3658992
