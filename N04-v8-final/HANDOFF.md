# Handoff autosuficiente · N04 v8 final

## Estado

N04 queda compuesto, exportado y auditado como PDF final candidato. El resultado usa el contenido canónico aprobado y no modifica N00, N01, N02 ni N03.

## Entregable principal

`output/N04-METSI-lectura-previa-v8-final.pdf`

- 32 páginas A4.
- 27.486.499 bytes al ejecutar la validación final.
- SHA-256: `36df2b286078a91dc254244eb0ff4ced1cd74ac9de0ccda1d26b9954620afaf4`.
...
- tapa fotográfica original, premium, cinematográfica y con representación argentina o latinoamericana;
...
- `validation-v8.json`: auditoría determinista integral.
...
- `qa/N04-cover-v8.png`: tapa renderizada.
- `page-spread-plan.json`: plan de páginas.
- `provenance/cover-image-premium-v1.md`: prompt, criterio y procedencia de tapa.
...
/Users/diegocarralbal/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 validate_n04_v8.py
```
