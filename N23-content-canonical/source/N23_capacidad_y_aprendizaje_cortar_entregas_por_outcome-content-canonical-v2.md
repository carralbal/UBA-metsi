...
## Cinco componentes terminados y ninguna llegada posible
...
El corte deja de ser una técnica para ordenar la lista de trabajo. Se convierte en una decisión sobre valor, riesgo, integración y quién queda fuera de la primera versión.
...
La escena revela una consecuencia de organizar el trabajo según la estructura interna. Cada especialidad recibe un paquete que puede completar con autonomía y demuestra progreso dentro de su frontera. La interfaz tiene pantallas, la API responde, las reglas pasan pruebas y la capacitación fue dictada. Sin embargo, la persona que llega al hotel no consume esos componentes por separado. Necesita que información, decisión, autoridad y acción material formen una trayectoria coherente. La unidad de entrega organizacional y la unidad de valor quedaron desacopladas.

Ese desacople produce una ilusión de reducción de riesgo. Dividir un alcance grande en tareas pequeñas puede mejorar coordinación y seguimiento, pero no reduce la incertidumbre principal si las partes no se confrontan hasta el final. En el hotel, la pregunta difícil no era si cada componente podía construirse. Era si varios estados con significados, tiempos y autoridades distintos permitían sostener una promesa. Completar primero las partes conocidas posterga precisamente la evidencia más valiosa.

Un corte vertical modifica la lógica de reducción. Limita población, episodio o variante, y conserva todas las capas indispensables para producir un resultado real. La primera versión puede atender sólo reservas directas, un turno y dos pisos. No puede omitir accesibilidad, reversión ni registro si esas condiciones forman parte de la promesa para esa población. Reducir alcance significa elegir una frontera defendible, no rebajar integridad.

El criterio de aprendizaje agrega otra pregunta. Entre varios cortes completos, conviene priorizar aquel que distingue la incertidumbre capaz de cambiar más decisiones. Una trayectoria manual instrumentada puede aprender antes que una automatización. Un contrato mínimo entre sistemas puede revelar una incompatibilidad semántica antes que una interfaz terminada. La elección se justifica por la evidencia que producirá y no por la visibilidad de la demostración.

La capacidad resultante es sociotécnica. Incluye tecnología, pero también permisos, decisiones humanas, instrucciones, soporte, datos y alternativas. Este punto separa N23 de una técnica genérica de partición de requisitos. El corte se valida en uso y operación, donde aparecen excepciones, cargas y consecuencias que una descomposición funcional no puede anticipar por completo.

## Hotel Horizonte: el primer slice debe completar una llegada

Al concluir su piloto de cuatro semanas, HH-22 dejó una hipótesis delimitada para reservas directas y una decisión de no ampliar la automatización a canales externos ni habitaciones accesibles. HH-23 comienza después de ese cierre y convierte la porción autorizada en una capacidad operable. Federico Müller propone entregar primero la nueva interfaz y luego integrar reglas, eventos y cerraduras. Lucía Ferreyra objeta que una pantalla sin decisión ni reparación no permite alojar a nadie. El corte se redefine alrededor de un episodio completo y no de componentes terminados.
...
La primera ejecución completa del slice, ya fuera de la ventana experimental de HH-22, encuentra una contradicción. Housekeeping declara la habitación limpia cuando finaliza su secuencia, pero Recepción necesita además una cerradura sincronizada, una asignación válida y una verificación de accesibilidad. La verificación de accesibilidad permanece bajo revisión humana y no habilita confirmación automática: Lucía valida la condición antes de entregar la habitación, de acuerdo con la salvaguarda establecida en HH-22. El corte no intenta resolver toda la semántica del hotel. Introduce una proyección compuesta y provisoria sólo para la población elegida, conserva los estados originales para auditoría y registra que el significado compartido sigue abierto. Esta solución limitada prueba el mecanismo sin imponer una migración total. N27 retomará la contradicción para convertir esa proyección local en un contrato verificable y decidir si corresponde crear el estado común `asignable`.
...
Una entrega produce valor y aprendizaje sólo si el corte vertical conserva una capacidad completa para una población delimitada, incluida integración, operación, reparación y retorno seguro. Falla cuando una sucesión de componentes terminados se presenta como outcome o cuando la expansión precede a la evidencia sobre el mecanismo crítico. La implicación profesional es elegir slices por la incertidumbre que pueden reducir y declarar población, deuda, riesgo y condición de ampliación antes de ejecutarlos.
...
N23 combina entrega evolutiva, aprendizaje sobre problemas, arquitectura, integración continua, seguridad y diseño incremental. Las fuentes permiten distinguir un corte que atraviesa la capacidad de una partición por componentes, y una exposición controlada de una entrega técnicamente desplegada.
...
## Movimiento 1 · Definir capacidad y outcome antes de cortar
...
## Movimiento 2 · Construir slices que atraviesen el sistema
...
## Movimiento 3 · Exponer, aprender y expandir sin ocultar deuda
...
En HH-23, uso se verifica con llegada directa anticipada en dos pisos. Operación se prueba durante el turno nocturno sin asistencia permanente de Federico. Reparación fuerza una cerradura sin respuesta y una condición accesible incompatible. Aprendizaje compara la hipótesis de dato tardío con la de significado divergente. La evidencia incluye tiempo hasta habitación utilizable, intervención manual, reasignación, reversión y explicación de la próxima decisión. Scarfone, Souppaya, Cody y Orebaugh (2008) y el SSDF de NIST (Scarfone, Souppaya y Dodson, 2022) anclan la integración de evaluación y seguridad durante el ciclo, no como control posterior.
...
El segundo corte amplía a otro turno y retira acompañamiento de Tecnología. Su pregunta no es si la función vuelve a ejecutarse, sino si la capacidad pertenece a la operación. El tercero incorpora un canal cuyo dato llega con otra temporalidad. Ese paso no reutiliza sin más la conclusión del primero: abre una hipótesis nueva sobre significado, vigencia y reparación. Beck (2004) y Cockburn (2004) fundamentan ciclos breves e integración frecuente; Fowler (2018) aporta la posibilidad de cambiar estructura preservando comportamiento. N23 los vincula con una secuencia decisional, no con una prescripción de tamaño fijo.
...
### Instrumento HH-23: mapa de cortes por capacidad
...
1. **Outcome.** Delimitar la condición que el corte debe modificar y evitar que una lista de componentes sustituya el resultado esperado.

2. **Población.** Precisar quién podrá usar el corte, quién quedará fuera y cómo se protegerán los casos excluidos.

3. **Hipótesis.** Formular qué aprendizaje habilitará el corte y qué resultado podría refutar la secuencia elegida.

4. **Capacidad mínima.** Definir la posibilidad completa y utilizable que debe existir, incluidos operación, soporte y reparación.

5. **Episodio de punta a punta.** Narrar desde el pedido hasta el resultado qué personas, decisiones, datos y excepciones atraviesa un caso real.

6. **Capas involucradas.** Identificar interfaz, reglas, datos, integración, operación y capacidades humanas necesarias para que el slice funcione.

7. **Excepciones.** Elegir qué variaciones cubre el primer corte y establecer una salida segura para las que todavía no cubre.

8. **Evidencia.** Definir qué uso, error, demora o consecuencia permitirá decidir sobre el siguiente corte.

9. **Definición de terminado.** Exigir que la capacidad pueda usarse, observarse, sostenerse y repararse en su alcance, no sólo desplegarse.

10. **Exposición.** Limitar población, volumen, duración y daño posible, con autoridad y mecanismo de reversión explícitos.

11. **Dependencias.** Ordenar capacidades previas y contratos críticos sin volver a dividir el slice por especialidades.

12. **Próximo corte.** Elegir la expansión que más reduce incertidumbre o agrega outcome con el menor compromiso adicional defendible.
...
### Caso de transferencia: devolución de una compra
...
### Contraejemplo: vertical sólo en el diagrama
...
La prueba ejecuta el slice como episodio de punta a punta. No alcanza con demostrar componentes: la población delimitada debe poder usar la capacidad, operación debe observarla y el equipo debe resolver al menos una excepción sin abandonar el alcance declarado.

El escenario adverso hace fallar una integración o presenta un caso excluido. HH-23 verifica que la salida manual protege a esa persona, que la exposición puede detenerse y que la definición de terminado incluye monitoreo y reparación.

La defensa compara el corte realizado con otra secuencia posible y justifica qué incertidumbre redujo. Si la evidencia sólo prueba que el código fue desplegado, el slice no habilita expansión ni aprendizaje sobre outcome.

La prueba también mide asistencia extraordinaria. Cada vez que una persona del equipo creador interviene, se registra motivo, duración y conocimiento faltante. La frecuencia puede disminuir, mantenerse o crecer. Una trayectoria que sólo funciona porque quienes la diseñaron corrigen estados en segundo plano no constituye una capacidad transferida.

El corte se somete además a una prueba de sustitución. Otra persona del mismo rol opera la trayectoria con la documentación y permisos previstos, sin recibir instrucciones privadas. El objetivo no es evaluar desempeño individual, sino descubrir si la capacidad depende de conocimiento tácito no transferido. Cada duda se registra como trabajo de diseño o como límite aceptado.

Una prueba de versión modifica una regla mientras existen episodios abiertos. El sistema debe conservar qué versión gobernó cada decisión y evitar que un cambio reinterprete retrospectivamente estados anteriores. Esta condición resulta central cuando varios componentes se despliegan con ritmos distintos. La integración temporal forma parte del corte aunque no aparezca en la interfaz.

Finalmente, la mesa compara el slice con una partición alternativa. Una opción podría cubrir más reservas con una ruta manual; otra podría automatizar menos casos y probar el contrato de cerraduras. La elección debe mostrar qué incertidumbre reduce, qué población protege y qué deuda acepta. Esta comparación impide presentar el orden construido como única secuencia técnicamente posible.

El escenario de expansión agrega una dimensión por vez. Puede duplicar volumen manteniendo canal y turno, o sumar un turno conservando volumen. Cambiar varias dimensiones simultáneamente impediría reconocer qué condición alteró el mecanismo. La decisión no necesita una causalidad perfecta, pero sí una progresión interpretable.

La auditoría del corte verifica que cada elemento del trabajo tenga relación con outcome, aprendizaje, protección o sostenimiento. Una funcionalidad sin esa relación se retira del corte. Una tarea operacional indispensable que no aparece se incorpora. El ajuste puede aumentar la cantidad de disciplinas involucradas y reducir el volumen total construido.

Finalmente, otra persona ejecuta la ruta de reversión y reconstruye el episodio desde registros. La capacidad no se aprueba si sólo el equipo conoce los pasos o si la trazabilidad depende de conversaciones privadas. Esta exigencia conecta definición de terminado con transferencia y gobierno.
...
### Dejar operación fuera de terminado
...
1. El corte más pequeño conserva un episodio completo, no la menor cantidad de componentes.

2. Primero se elige la incertidumbre decisiva, no la tarea más fácil de demostrar.

3. Terminado reúne uso, operación, reparación y una decisión que la evidencia permite tomar.

4. Una proyección local puede habilitar aprendizaje sin convertirse todavía en contrato compartido.

5. Ampliar población, canal, volumen o automatización reabre hipótesis diferentes.
...
1. ¿Qué diferencia existe entre completar componentes y habilitar una capacidad utilizable?

2. ¿Qué capas debe atravesar el primer slice para completar un episodio de punta a punta?

3. ¿Qué corte reduciría la incertidumbre más peligrosa con la menor exposición posible?

4. ¿Qué población y condición cambiarían con el corte, más allá de que la funcionalidad esté disponible?

5. ¿Qué contrato, dato o práctica conviene confrontar temprano aunque no resulte visible en una demostración?

6. ¿Qué debería poder usarse, observarse y repararse para declarar terminado el primer corte?
...
**Kent Beck.** Integró entregas pequeñas, pruebas, diseño evolutivo y retroalimentación frecuente.

**Steve Blank.** Vinculó versiones limitadas con hipótesis sobre problemas, clientes y propuestas de valor.

**Grady Booch.** Desarrolló recursos de arquitectura y modelado para sistemas complejos que evolucionan por incrementos.

**Martin Fowler.** Articuló integración continua, refactorización y evolución segura de diseño.

**Karen Scarfone.** Integró pruebas y evaluación de seguridad dentro del ciclo de desarrollo y operación.

**Alistair Cockburn.** Formuló el walking skeleton como estrategia de integración.

## Referencias base

- Beck, K. (2004). *Extreme Programming Explained*, Second Edition. Addison-Wesley.
...
- DeBellis, D. et al. (2025). *DORA 2025 State of AI-assisted Software Development Report*. https://research.google/pubs/dora-2025-state-of-ai-assisted-software-development-report/

- Scarfone, K., Souppaya, M. y Dodson, D. (2022). *Secure Software Development Framework (SSDF) Version 1.1: Recommendations for Mitigating the Risk of Software Vulnerabilities*. NIST SP 800-218. https://doi.org/10.6028/NIST.SP.800-218
