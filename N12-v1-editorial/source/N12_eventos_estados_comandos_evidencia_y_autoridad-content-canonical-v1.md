...
**Eric Evans.** Articuló el diseño dirigido por el dominio y la necesidad de construir un lenguaje compartido entre especialistas y software.
...
**David Ferraiolo y Richard Kuhn.** Contribuyeron al modelo de control de acceso basado en roles y a la separación entre usuarios, roles, permisos y restricciones.

**Nancy Leveson.** Desarrolló una concepción sociotécnica de seguridad basada en control, restricciones y retroalimentación.

**Elham Tabassi.** Lideró el NIST AI RMF, que exige responsabilidades explícitas para decisiones y configuraciones entre personas e inteligencia artificial.
