# N10 · Construir el problema: de síntomas a outcomes verificables
## Pregunta profesional

¿Cómo formular un problema que permita actuar sin convertir la primera explicación, o la solución preferida, en una verdad demasiado pronto?
...
Una analista decide mirar episodios completos. No cuenta sólo vehículos: acompaña viajes. Descubre que gran parte de las personas cruza el río porque tres oficinas públicas, dos universidades y un hospital comienzan actividades dentro de la misma ventana de cuarenta minutos.

Observa también que los colectivos quedan atrapados en la misma fila que los autos, que una línea de tren tiene capacidad disponible una hora antes y que muchos trámites exigen presencia aunque podrían distribuirse durante el día. Del otro lado del puente, un semáforo mal coordinado retiene la salida y hace que la congestión parezca originarse en la calzada.

La ciudad ya no tiene un único problema evidente. Puede tener una restricción de infraestructura, una concentración de horarios, una falla de coordinación del transporte, una regla administrativa o una combinación. Cada encuadre vuelve razonables intervenciones diferentes. Un segundo puente amplía capacidad, pero también puede atraer más autos y trasladar la cola al centro. Carriles exclusivos mejoran el transporte colectivo, pero requieren decidir quién pierde espacio.

Escalonar horarios reduce el pico, aunque obliga a coordinar instituciones autónomas. Corregir el semáforo es barato y reversible, pero quizá sólo trate una parte de la demora.
...
La historia todavía admite una escena más. Antes de aprobar la obra completa, la ciudad decide utilizar seis semanas para probar el encuadre. No busca “demostrar que el puente no hace falta”; busca descubrir qué intervención merece consumir opciones durante décadas.

Coordina durante diez días los horarios de dos oficinas, establece prioridad temporal para colectivos, corrige el semáforo de salida y registra viajes completos en lugar de contar únicamente vehículos. También entrevista a quienes no pueden modificar su horario, a comerciantes del acceso y a personal del hospital. Ninguna prueba reproduce exactamente una obra nueva, pero cada una permite observar mecanismos que la maqueta no muestra.

Los resultados no entregan una respuesta limpia. La coordinación horaria reduce el pico matinal, aunque parte de la demanda se desplaza a la tarde. El carril prioritario mejora el tiempo de los colectivos y empeora durante algunos minutos el de los automóviles. El ajuste del semáforo elimina una cola secundaria, pero no modifica los días de mayor concentración.

Aparece además un dato que ningún conteo de calzada había revelado: muchas personas eligen el auto porque la combinación entre tren y colectivo no garantiza llegar antes del inicio de su turno. La confiabilidad, y no solamente la duración promedio, forma parte del outcome.

Con esa evidencia, el debate deja de ser “puente sí o puente no”. La ciudad puede formular una cartera: coordinación de horarios, confiabilidad del transporte público, gestión de accesos y, si la demanda residual lo justifica, infraestructura adicional. También puede declarar guardrails: no aumentar accidentes, no desplazar contaminación hacia barrios con menor capacidad de protesta y no empeorar el acceso de quienes carecen de alternativas.

El nuevo puente sigue siendo una posibilidad, pero ya no funciona como definición del problema ni como única medida del progreso.
...
Un problema profesional no es un dato que espera ser descubierto ni una frase que resume síntomas. Es un argumento que relaciona una situación indeseada, las personas afectadas, mecanismos posibles, outcomes, fronteras, restricciones, riesgos y evidencia disponible. Debe ser suficientemente específico para elegir qué investigar o cambiar y suficientemente abierto para admitir explicaciones rivales y resultados inesperados.
...
El problema provisional agrega una exigencia. Antes de la reunión, el equipo debe declarar qué outcome espera modificar y qué deterioros no aceptará. Puede proponer: “reducir el tiempo desde la llegada hasta una asignación correcta en reservas con discrepancias, sin aumentar errores de identidad, habitaciones entregadas en condiciones inadecuadas ni dependencia de una única persona supervisora”. Esa frase permite conversar con el proveedor de otra manera.

En lugar de preguntar solamente qué funciones ofrece el producto, pregunta qué estados necesita, cómo representa excepciones, qué decisiones automatiza, qué rastros conserva, quién puede corregir y cómo se revierte una acción equivocada.

Las primeras dos horas no producen el diagnóstico definitivo. Producen una diferencia verificable entre cuatro comienzos posibles. Si los episodios muestran que la espera ocurre antes de toda consulta al PMS, la hipótesis de integración pierde fuerza. Si la demora aparece cuando dos áreas usan definiciones incompatibles, el equipo debe trabajar semántica y autoridad, aunque también cambie tecnología.

Si la mayoría de los casos depende de concentración física de llegadas, quizás la capacidad y el diseño del servicio pesen más. Si el daño se concentra en personas que necesitan asistencia, el promedio general deja de ser el outcome suficiente.
...
- la evidencia que explica sin ignorar contradicciones;
- la claridad de los mecanismos que propone;
- la inclusión de actores y consecuencias relevantes;
- la capacidad de generar alternativas distintas;
...
### Cuatro encuadres rivales para Hotel Horizonte
...
## Primera aplicación de HH-10: mantener encuadres rivales
...
- **fenómeno:** qué cambia;
- **población o unidad:** para quién o dónde;
- **dirección y magnitud orientativa:** cuánto o en qué sentido;
- **ventana temporal:** cuándo se observará;
- **protecciones:** qué no debe empeorar;
- **evidencia:** cómo se reconocerá el cambio;
- **decisión asociada:** qué acción corresponderá según el resultado.
...
El modelo lógico de la W. K. Kellogg Foundation ayuda a explicitar esa cadena, pero no prueba por sí solo que la relación sea causal.
...
- **tempranas:** aparecen cerca del mecanismo, como divergencia de estados o demora de propagación;
- **de resultado:** muestran el outcome, como llegadas con corrección y tiempo hasta habitación adecuada;
- **de equilibrio o daño:** revelan desplazamiento, como contactos repetidos, reubicaciones, abandono o carga manual.
...
- quién propuso cada encuadre;
- quién aporta evidencia;
- quién tiene autoridad para decidir;
- quién recibirá beneficio o carga;
- quién puede cuestionar y pedir revisión;
- quién debe reparar si la intervención daña.
...
## Segunda aplicación de HH-10: outcome, protecciones y autoridad
...
## Instrumento HH-10: encuadre METSI en nueve decisiones

El instrumento no se completa necesariamente en orden. Cada campo funciona como una pregunta de consistencia.

1. **Situación:** ¿qué episodios o patrones están observados y qué falta saber todavía?
2. **Afectados y perspectivas:** ¿quién vive la situación, quién obtiene valor, quién asume carga y quién no está representado?
3. **Outcome:** ¿qué condición o capacidad debería cambiar, para quién y en qué ventana?
4. **Mecanismos rivales:** ¿qué relaciones podrían producir la situación y qué predice cada explicación?
5. **Evidencia y vacíos:** ¿qué sostiene cada mecanismo, qué lo contradice y qué dato falta?
6. **Frontera:** ¿qué se incluye para esta decisión, qué queda como entorno y qué riesgo tiene la exclusión?
7. **Restricciones y preferencias:** ¿qué no puede cambiarse, qué está comprometido y qué es solo una solución deseada?
8. **Protecciones y reparación:** ¿qué daño no debe ocultarse, cómo se detectará y quién podrá detener o reparar?
9. **Condición de revisión:** ¿qué hallazgo obligará a reformular el problema o separar problemas diferentes?
...
Los campos no deben revisarse de manera aislada. Un cambio en uno obliga a examinar los demás. Si la población prioritaria pasa de “todas las llegadas” a “reservas intermediadas que requieren asistencia”, probablemente cambien el outcome, la muestra, los mecanismos y las protecciones. Si un contrato impide modificar el canal durante un año, la restricción altera las alternativas pero no convierte al contrato en explicación causal.

Si una nueva traza descarta latencia, debe revisarse el mecanismo y quizá la frontera, no solamente reemplazar una palabra.

Una comprobación rápida consiste en recorrer cuatro coherencias:

- **evidencia y mecanismo:** ¿los datos observados serían esperables si el mecanismo fuera verdadero y existe alguna observación que podría contradecirlo?;
- **mecanismo e intervención:** ¿la acción propuesta modifica realmente la relación causal o solo un síntoma cercano?;
- **outcome y señal:** ¿la medición representa el cambio relevante y permite detectar distribución o desplazamiento?;
- **autoridad y reparación:** ¿quien decide tiene capacidad y obligación para responder por las consecuencias?
...
Otra prueba consiste en imaginar que, dentro de seis meses, el proyecto entregó todos sus outputs y el outcome no cambió. El equipo debe proponer desde ahora dos explicaciones para ese fracaso: una en la que la intervención no modificó el mecanismo y otra en la que la medición ocultó el resultado real. Si no puede hacerlo, el encuadre probablemente une solución y éxito mediante una garantía tácita.

Esta anticipación del fracaso mejora el diseño de evidencia y evita que la evaluación futura se limite a justificar la inversión.
...
## De N01 a N09: la evidencia acumulada todavía no es el problema
...
- qué situación se considera indeseada y para quién;
- qué mecanismos rivales podrían producirla;
- qué parte del sistema resulta relevante para la próxima decisión;
- qué outcome permitiría reconocer una mejora;
- qué guardrails evitan declarar éxito mediante desplazamiento del daño;
- qué evidencia falta y qué hallazgo revisaría el encuadre.
...
## Tercera aplicación de HH-10: formulación provisional para Hotel Horizonte
...
> Las consecuencias se concentran en reservas intermediadas, momentos de alta demanda y situaciones que requieren asistencia, aunque la distribución todavía debe validarse. La intervención busca reducir la frecuencia y duración de correcciones evitables sin disminuir accesibilidad, continuidad, capacidad de excepción ni responsabilidad frente al huésped.

> Antes de comprometer una solución se distinguirá el peso relativo de integración, semántica, política comercial y capacidad de reparación. Si los episodios no muestran divergencia entre esos mecanismos, el encuadre deberá reformularse.
...
## Caso de transferencia: demoras en una guardia
...
- **Convertir el pedido en diagnóstico.** El presupuesto, la urgencia o la preferencia de una autoridad informan restricciones, pero no prueban el mecanismo.
- **Nombrar un síntoma como si fuera una causa.** “Hay demora” orienta la observación; no explica qué relación produce esa demora.
- **Elegir una sola explicación antes de buscar evidencia discriminante.** El encuadre se vuelve inmune a señales adversas y protege la solución preferida.
- **Confundir output con outcome.** La entrega correcta de una aplicación no demuestra que haya cambiado la capacidad o condición que justificó la inversión.
- **Usar un promedio sin examinar distribución.** Una mejora agregada puede ocultar mayor daño para casos complejos o personas que necesitan asistencia.
- **Agregar protecciones genéricas.** Una lista de valores sin mecanismo de daño, señal, autoridad y reparación no limita ninguna decisión real.
- **Buscar consenso mediante una frase vacía.** El acuerdo aparente puede borrar conflictos legítimos entre ocupación, carga de trabajo, accesibilidad y confiabilidad.
- **Cerrar la investigación sin puerta de decisión.** Acumular información sin declarar qué habilita, qué devuelve y qué obliga a reformular posterga la responsabilidad.
...
El producto no afirma haber encontrado el problema verdadero. Afirma algo más útil y auditable: con la evidencia actual, este encuadre permite decidir el próximo paso sin ocultar rivales ni daños, y contiene criterios capaces de refutarlo. N11 recibirá las afirmaciones y rastros del paquete para examinar cómo una representación de datos conserva procedencia, temporalidad, significado y autoridad suficientes para modelar y decidir.

Así termina el Bloque 1: no con una receta ni con una solución, sino con un problema que puede ser defendido, discutido y revisado.
...
1. **El pedido describe una preferencia; el problema explica una situación.**
2. **Un síntoma puede sostener varios mecanismos rivales.**
3. **El outcome nombra el cambio, la población y el horizonte.**
4. **Una protección declara qué éxito no autoriza.**
5. **Todo encuadre serio incluye evidencia que podría obligarlo a cambiar.**

## Glosario esencial

- **Encuadre:** argumento provisional que relaciona situación, actores, mecanismo y decisión.
- **Síntoma:** señal observable que indica una situación sin explicar todavía su causa.
- **Mecanismo:** relación que propone cómo ciertas condiciones producen un resultado.
- **Outcome:** cambio relevante en capacidad o condición para una población y horizonte.
- **Output:** producto inmediato de una actividad, como una pantalla o informe.
- **Protección o guardrail:** límite que protege condiciones que el outcome no debe deteriorar.
- **Anti-outcome:** resultado adverso explícito que la intervención debe evitar.
- **Condición de revisión:** evidencia que obliga a reformular el encuadre.

## Preguntas de preparación

1. ¿Qué evidencia distinguiría en Hotel Horizonte latencia tecnológica, incompatibilidad semántica y política comercial?
2. ¿Qué output podría entregarse exitosamente sin mejorar el outcome definido en esta lectura?
3. ¿Qué protección y qué anti-outcome deberían formularse para una iniciativa de check-in digital, y qué mecanismo de daño intentaría evitar cada uno?
4. ¿Qué hallazgo obligaría a separar el problema de sobreventa del problema de llegada?
5. ¿Quién queda con menos voz en la formulación provisional y cómo podría incorporarse su evidencia sin fingir consenso?
6. ¿Qué nivel de evidencia correspondería exigir antes de observar, realizar una prueba piloto, contratar y migrar, y cómo se justifican las diferencias por reversibilidad y daño?
...
- Jackson, M. (2001). *Problem Frames: Analysing and Structuring Software Development Problems*. Addison-Wesley. Se utiliza para distinguir su concepto específico de la síntesis METSI.
...
- Pawson, R., & Tilley, N. (1997). *Realistic Evaluation*. Sage. Referencia para razonar en términos de contexto, mecanismo y resultado.
- W. K. Kellogg Foundation (2004). *Logic Model Development Guide*. Se usa críticamente como apoyo para explicitar relaciones, no como prueba causal.
- ISO/IEC/IEEE 29148:2018. *Systems and software engineering, Life cycle processes, Requirements engineering*. Referencia para contexto, necesidades, restricciones y trazabilidad, sin adoptar el estándar como receta metodológica. https://www.iso.org/standard/72089.html
- World Economic Forum (2025). *The Future of Jobs Report 2025*. Se utiliza como señal global fechada, no como pronóstico determinista. https://www.weforum.org/publications/the-future-of-jobs-report-2025/
...
- Unión Europea (2024). *Reglamento (UE) 2024/1689 sobre inteligencia artificial*. https://eur-lex.europa.eu/eli/reg/2024/1689/oj
- DORA (2025). *State of AI-assisted Software Development*. https://dora.dev/research/2025/dora-report/
- IEEE Computer Society (2024). *Guide to the Software Engineering Body of Knowledge, Version 4*. https://www.computer.org/education/bodies-of-knowledge/software-engineering/v4
