# N20 · Estrategia metodológica: adaptación, hitos y condiciones de salida

## Pregunta profesional

¿Cómo combinar prácticas de trabajo para aprender, entregar, gobernar y cerrar una intervención sin seguir una receta ni improvisar?

## El programa tenía todas las prácticas y ninguna salida
...
El nuevo mapa revela incompatibilidades. La revisión exige decisiones semanales, pero el comité regulatorio se reúne una vez por mes. El piloto necesita datos que la migración sólo producirá al final. La auditoría pide registros que la configuración actual no conserva. Ninguna práctica es absurda por sí sola. El problema aparece al combinarlas: producen esperas, duplicación y evidencia tardía.

En gestión, adaptar el conjunto al contexto suele llamarse *tailoring*. No significa recortar ceremonias, sino decidir qué función cumple cada práctica, cómo se relacionan y cuándo dejan de hacer falta.
...
## Hotel Horizonte: una estrategia con puertas que pueden detener
...
Las fuentes ayudan a separar procesos, estrategia y aprendizaje. PMI e ISO/IEC/IEEE explican cómo adaptar un ciclo de vida. Boehm relaciona el compromiso con el riesgo. Schön y Mintzberg muestran por qué una estrategia debe revisarse mientras se actúa. SEBoK y NIST ayudan a precisar decisiones, evidencia y responsabilidades.
...
ISO/IEC/IEEE guía la aplicación situada y la adaptación de procesos de ciclo de vida.
...
Entre estas ideas existe una tensión útil. Un marco de ciclo de vida favorece la cobertura y la trazabilidad. La reflexión durante la acción recuerda que la situación cambia al intervenir. La adaptación metodológica no obliga a elegir una tradición y descartar la otra. Conserva las funciones necesarias y define cómo la evidencia puede modificar la secuencia. Un proceso documentado puede adaptarse y una práctica flexible puede dejar trazabilidad.

N20 no trata el Manifiesto Ágil como catálogo ni al PMBOK como receta. Los usa para discutir valores, principios y funciones. La guía de PMI presenta la adaptación como una elección continua. Las normas 15288 y 24748 permiten combinar procesos sin imponer un único orden. La estrategia debe responder a una institución, un episodio y una consecuencia, no a una identidad metodológica.

## Movimiento 1 · Partir de decisiones, incertidumbre y contexto
...
La adaptación permanece abierta a revisión. Una práctica adecuada durante el descubrimiento puede convertirse en una carga cuando la capacidad se estabiliza. Otra puede necesitar más intensidad cuando crece la población alcanzada. La fecha de revisión y la condición de retiro evitan conservar burocracia o eliminar protecciones demasiado pronto. El método puede cambiar. La obligación de justificarlo permanece.
...
Un principio ayuda a juzgar una decisión. Un dominio obliga a observar una dimensión del desempeño. Un proceso organiza trabajo que puede adaptarse. Copiar los tres niveles como una lista de cumplimiento elimina justamente el razonamiento que la adaptación necesita.

En HH-20 la migración del PMS no adopta un método único. La gobernanza de la promesa y del presupuesto se planifica con puertas explícitas. La integración se desarrolla en cortes verificables. La experiencia de llegada se prueba con personas y episodios. La transición operacional requiere ensayo, capacitación y contingencia.

Cada práctica se elige por la evidencia o la coordinación que aporta, y su intensidad cambia con riesgo, reversibilidad y población. El expediente registra qué parte de la estrategia responde a valor, alcance, cronograma, finanzas, interesados, recursos o riesgo, sin suponer que esos dominios constituyen departamentos separados.

Hitos, puertas y condiciones de salida tampoco son sinónimos. Un hito marca un punto significativo del recorrido; una puerta contiene autoridad para continuar, modificar o detener; una condición de salida describe la evidencia mínima que permite cerrar un tramo. La fecha de demostración puede ser un hito sin habilitar exposición. Una revisión puede llamarse puerta y ser ceremonial si nadie puede detener.

Un listado de tareas completas puede no satisfacer salida si el sistema todavía no se usa, observa o repara. La estrategia gana rigor cuando cada dispositivo conserva su consecuencia.
...
La incorporación de inteligencia artificial modifica varios factores a la vez. Aumenta la novedad cuando el comportamiento no está estabilizado, crea dependencia de datos y proveedores, y puede volver más difícil detectar errores porque una respuesta plausible oculta su incertidumbre. La adaptación debe agregar evaluación por población, identificación de versión, supervisión efectiva y una ruta de retirada. Copiar el control usado para software determinista deja fuera la deriva, la variabilidad y la dificultad para explicar resultados.
...
Los conflictos de autoridad requieren una regla previa. Si Operaciones detiene por una discrepancia material y Comercial solicita continuar por una ventana de temporada, la estrategia no convoca una negociación sin límite. Mantiene la detención, identifica qué obligación o evidencia podría levantarla y deriva sólo la decisión que excede la autoridad local.

La persona que revisa no puede cambiar el umbral después de observar el resultado sin registrar una nueva versión y explicar su efecto sobre casos ya expuestos. Esta disciplina transforma el escalamiento en una excepción gobernada y no en una forma de desplazar responsabilidad.

## Movimiento 2 · Componer prácticas con puertas verificables
...
Detener distribuye costos y puede encontrar resistencia. Comercial pierde una campaña, el proveedor posterga facturación y el equipo reconoce un supuesto fallido. Definir autoridad y consecuencia antes de observar evita que esas presiones cambien el umbral retrospectivamente. Una organización aprende cuando puede frenar sin convertir la decisión en culpa personal.

## Movimiento 3 · Revisar la estrategia sin borrar el aprendizaje
...
La proporcionalidad también limita la concentración de poder. Una autoridad superior puede resolver un conflicto, pero no apropiarse de toda decisión cotidiana ni invalidar evidencia local sin fundamento. El registro separa quién recomienda, quién decide, quién ejecuta y quién puede detener. Cuando esos papeles recaen en una misma persona, HH-20 exige una revisión independiente para consecuencias de alto impacto.

ISO/IEC/IEEE 16085:2021 vincula gestión del riesgo con responsabilidades y seguimiento durante el ciclo de vida; el instrumento traduce ese principio a decisiones observables, recursos disponibles y plazos de respuesta.
...
## Instrumento HH-20: estrategia metodológica situada
...
1. **Outcome y población.** Delimitar la condición que se busca cambiar, para qué población y con qué diferencias relevantes entre grupos.

2. **Hipótesis estratégica.** Expresar cómo la combinación de acciones produciría capacidad y qué mecanismo rival podría explicar el resultado.

3. **Factores situacionales.** Registrar criticidad, novedad, regulación, distribución, tamaño, competencias y reversibilidad que condicionan la adaptación.

4. **Decisiones y dependencias.** Ordenar las decisiones que habilitan otras, indicando responsables, evidencia y restricciones de secuencia.

5. **Lógicas por tramo.** Asignar anticipación, iteración, incremento, adaptación o experimento según la incertidumbre y el daño posible de cada tramo.

6. **Prácticas por función.** Justificar cada ceremonia, artefacto o control por la función que cumple y definir cuándo deja de ser necesario.

7. **Evidencia y cadencia.** Asociar cada hipótesis con una señal, una fuente y un ritmo de observación proporcional a la velocidad del riesgo.

8. **Hitos.** Definir estados verificables que habilitan, limitan o modifican decisiones, sin tratarlos como fechas sin consecuencia.

9. **Entrada y salida.** Establecer condiciones mínimas para comenzar y evidencia suficiente para cerrar, transferir o ampliar cada actividad.

10. **Autoridad y escalamiento.** Asignar decisiones al nivel que posee información y capacidad de respuesta, con una ruta explícita para conflictos y excepciones.

11. **Detención y contingencia.** Fijar señales que obligan a detener y una respuesta ensayada para proteger servicio, datos y personas durante la interrupción.

12. **Transferencia, revisión y retiro.** Precisar cómo pasan capacidad y conocimiento a operación, cuándo se revisa la estrategia y qué estructuras temporales deben desaparecer.
...
Si falla, el expediente conserva qué condición no se alcanzó y qué trabajo puede continuar sin aumentar exposición. Este ejemplo permite contrastar una ficha realmente ejecutable con una lista de campos completos y deja a HH-21 una capacidad operacional, no sólo un despliegue.

## Caso de transferencia: implementación de una política de evaluación
...
## Contraejemplo: la transformación que nunca termina
...
El escenario adverso elimina una persona clave, demora una dependencia y hace fallar la primera hipótesis estratégica. HH-20 debe indicar qué señal detiene, quién decide la contingencia y cómo se conserva la capacidad de operar mientras se adapta el método. Si la única respuesta es agregar una ceremonia, la adaptación no resolvió el problema.
...
La evaluación incluye un cambio de contexto. Se simula temporada alta o una nueva obligación y se pregunta qué parte de la estrategia se adapta. Los principios y derechos permanecen; los ritmos, los controles y la población pueden variar. Si el instrumento no permite localizar qué cambiar, la adaptación quedó congelada como receta.
...
**Elegir prácticas antes de funciones.**
...
**Iniciar sin autoridad ni contingencia.**
...
**Cerrar por actividad completada.**
...
**Cambiar criterios después de ver el resultado.**
...
**Usar la adaptación para ocultar pérdida de rigor.**
...
La adaptación puede convertirse en arbitrariedad si sólo refleja preferencias o presión de plazo. También puede agregar controles innecesarios y crear colas de decisión. HH-20 exige conservar funciones, autoridad y evidencia, pero admite que la estrategia cambie cuando cambian las condiciones.
...
Una estrategia metodológica es una hipótesis sobre cómo producir capacidad bajo condiciones concretas. La adaptación selecciona procesos por función y ajusta su intensidad según la incertidumbre, las consecuencias y la posibilidad de volver atrás.
...
1. Una práctica entra por la función que cumple y sale cuando esa función deja de ser necesaria.

2. Un hito sin decisión asociada es sólo una fecha con otro nombre.

3. Cambiar un criterio después del resultado exige una nueva versión y una justificación visible.

4. Poder detener requiere señal, autoridad, contingencia y capacidad real de actuar.

5. Transferir implica que operación pueda usar, observar y reparar sin conocimiento privado del proyecto.
...
1. ¿Qué relación causal afirma una estrategia metodológica y qué resultado obligaría a revisarla?

2. ¿Qué función cumple cada práctica seleccionada y cuál podría retirarse sin perder capacidad de decisión?

3. ¿Qué factores del episodio exigen más anticipación, supervisión o posibilidad de detención?

4. ¿Qué decisión habilita a cuál y dónde una dependencia vuelve inviable la secuencia actual?

5. ¿Qué cambia realmente al alcanzar cada hito y por qué una fecha por sí sola no alcanza?

6. ¿Qué evidencia permitiría transferir la capacidad a operación y qué estructura temporal debería retirarse?
...
**Barry Boehm.** Vinculó compromiso progresivo y reducción de riesgo.

**Donald Schön.** Explicó reflexión y revisión en la práctica profesional.

**Henry Mintzberg.** Mostró la relación entre estrategia deliberada y emergente.

**Rita Gunther McGrath.** Desarrolló estrategia bajo incertidumbre, ventajas transitorias y retiro disciplinado de apuestas.

**Kent Beck.** Formuló principios adaptativos que subordinan la práctica a la retroalimentación y el cambio.

**Alistair Cockburn.** Desarrolló una concepción situada de métodos, personas y restricciones de proyecto.
...
- Mintzberg, H. y Waters, J. A. (1985). “Of Strategies, Deliberate and Emergent”. *Strategic Management Journal*, 6(3), 257 a 272. https://doi.org/10.1002/smj.4250060306

- McGrath, R. G. (2013). *The End of Competitive Advantage*. Harvard Business Review Press.

- SEBoK (2026). *Decision Management*. https://sebokwiki.org/wiki/Decision_Management
...
- Varsavsky, O. (1974). *Estilos tecnológicos: propuestas para la selección de tecnologías bajo racionalidad socialista*. Periferia.
