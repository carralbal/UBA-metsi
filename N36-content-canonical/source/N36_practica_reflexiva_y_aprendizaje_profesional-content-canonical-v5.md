...
Que algo haya salido bien no demuestra que entendamos por qué salió bien. Aprender de una intervención exige volver a lo ocurrido: qué sabíamos, qué elegimos, qué nos sorprendió y qué pasó después. El aprendizaje se vuelve real cuando cambia nuestra manera de actuar o de decidir y cuando podemos probar ese cambio en otra situación. La inteligencia artificial puede ayudarnos a encontrar preguntas y comparar relatos, pero las personas deben comprobar los hechos, elegir un camino y hacerse cargo del resultado.
...
## Movimiento 1 · Reconstruir una experiencia sin maquillarla
...
Una sorpresa útil se cuenta con precisión. No alcanza con decir que algo salió raro. Hay que decir qué se esperaba, qué ocurrió, a quién afectó y qué idea quedó en duda. Esa forma de contarla evita dos atajos: culpar a una persona por toda diferencia o llamar excepción a cualquier dato que incomoda nuestra primera idea.
...
## Movimiento 2 · Convertir la revisión en un cambio verificable
...
## Movimiento 3 · Hacer que aprender sea una capacidad compartida
...
## Hotel Horizonte: el buen resultado abrió una pregunta mejor
...
## Instrumento HH-36: una conversación en doce preguntas
...
1. **¿Qué episodio se revisa?** Elegir una situación concreta, quiénes participaron y dónde comenzó y terminó.

2. **¿Qué se esperaba?** Escribir qué creíamos que iba a pasar y por qué.

3. **¿Qué se sabía al decidir?** Separar los datos disponibles entonces de lo que conocimos después.

4. **¿Qué decisión se tomó?** Anotar qué otras opciones había, quién podía elegir y qué presión existía.

5. **¿Qué ocurrió?** Contar efectos, daños, reparaciones y trabajo extra, no sólo el número principal.

6. **¿Qué sorprendió?** Nombrar la diferencia que nuestra primera explicación no puede aclarar.

7. **¿Qué regla orientó realmente la acción?** Comparar lo que se hizo con lo que se decía que debía hacerse.

8. **¿Qué otra explicación es posible?** Proponer otra causa y un dato que permita compararla con la primera.

9. **¿Qué debe cambiar?** Decidir si alcanza con corregir una acción o si también deben cambiar la meta, la regla o quién elige.

10. **¿Cómo se practicará?** Elegir algo concreto que otra persona deba poder hacer, una dificultad y una devolución.

11. **¿Qué aportó la IA?** Guardar qué se le pidió, qué idea resultó útil, cómo se comprobó y qué se descartó.

12. **¿Dónde podría fallar la nueva explicación?** Elegir una situación futura, una persona responsable y una fecha.
...
## Caso de transferencia: una primera experiencia profesional
...
1. Que algo salga bien no demuestra que sepamos por qué salió bien.

2. Para aprender hay que recordar qué sabíamos y qué elegimos antes de conocer el final.

3. Una sorpresa sirve cuando abre otra explicación y una manera de comprobarla.

4. Corregir una acción no es lo mismo que cambiar la regla con la que medimos el éxito.

5. Aprendimos cuando podemos actuar mejor y otra situación permite demostrarlo.
...
**Teoría declarada y teoría en uso:** diferencia entre la regla que decimos seguir y la que muestran nuestras acciones.
...
1. ¿Qué decisión reciente cambiaste mientras todavía estabas actuando y qué señal te hizo cambiarla?

2. ¿Qué sabías en ese momento y qué entendiste recién después?

3. ¿Qué sorpresa muestra que la primera explicación no alcanza?

4. ¿Qué diferencia hay entre lo que se decía que debía hacerse y lo que realmente se hizo?

5. ¿La respuesta corrigió una acción o cambió también la meta, la regla o quién podía decidir?

6. ¿Qué debería poder hacer otra persona y en qué situación podrías comprobar que hubo aprendizaje?

Para el encuentro, elegir una decisión propia. Anotar qué esperabas, en qué datos te apoyaste, qué te sorprendió y qué otra explicación es posible. Proponer un cambio concreto y una situación futura para probarlo.
...
**David Kolb.** Modela el aprendizaje experiencial como transformación entre experiencia, observación y experimentación.

**Amy Edmondson.** Estudia seguridad psicológica, voz, error y aprendizaje en equipos.

**Paulo Freire.** Vincula reflexión, diálogo y acción transformadora sin reducir el aprendizaje a recibir respuestas.
...
- Ericsson, K. A., Krampe, R. T. y Tesch-Römer, C. (1993). “The Role of Deliberate Practice in the Acquisition of Expert Performance”. *Psychological Review*, 100(3), 363 a 406. https://doi.org/10.1037/0033-295X.100.3.363
