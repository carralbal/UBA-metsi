...
### Stakeholders, preocupaciones y viewpoints
...
### Tercera aplicación de HH-15: cinco modelos para una decisión de arribo
...
### Modelar lo vigente y lo propuesto juntos
...
### Tratar el log o el código como realidad completa
...
6. ¿Qué riesgos introduce generar representaciones automáticamente desde código o logs?
...
**Peter Checkland.** Utilizó modelos conceptuales como dispositivos de aprendizaje en situaciones problemáticas.

**John Sterman.** Desarrolló modelado de dinámica de sistemas para explicar comportamiento y retroalimentación.

**Daniel Moody.** Propuso principios para evaluar notaciones visuales y carga cognitiva.

**Simon Brown.** Creó C4 como conjunto selectivo de abstracciones y vistas de arquitectura de software.

**Marc Lankhorst.** Integró arquitectura empresarial y lenguaje ArchiMate en una práctica orientada a stakeholders.
...
- Moody, D. (2009). “The Physics of Notations”. *IEEE Transactions on Software Engineering*, 35(6), 756–779. https://doi.org/10.1109/TSE.2009.67
...
- Brown, S. (2026). *The C4 Model for Visualising Software Architecture*. https://c4model.com/
