...
No se aprueba un nombre comercial para siempre. Se aprueba un uso concreto, para una población concreta y con una configuración que pueda comprobarse. Si cambian el propósito, las fuentes, la versión, los permisos, el proveedor, la autonomía o el contexto, también puede dejar de valer la evidencia anterior. Un gobierno vivo une inventario, autoridad, origen de datos y modelos, evaluación, monitoreo, incidentes, reclamos, reparación y retiro.

No se mide por la cantidad de políticas publicadas. Se mide por la capacidad de detectar un cambio importante, limitar el uso, reconstruir decisiones y corregir consecuencias antes de que la aprobación quede sólo en un acta vieja.
