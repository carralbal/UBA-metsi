...
## El trámite aprobó todas las pruebas y dejó afuera a quienes más lo necesitaban

Un organismo público reemplaza la solicitud presencial de un subsidio por un portal. Antes del lanzamiento, el equipo ejecuta pruebas funcionales, de carga y de seguridad. Los formularios se envían, los archivos se almacenan y el tiempo medio queda por debajo del objetivo. El informe concluye que el servicio posee calidad suficiente para abrirse a toda la población.

Durante la primera semana, los indicadores generales siguen siendo favorables. Sin embargo, organizaciones territoriales informan que muchas personas completan el trámite y no reciben constancia, que la sesión vence cuando se usa una conexión inestable y que el lector de pantalla no anuncia dos errores obligatorios. Quienes pueden volver a intentarlo resuelven el problema. Quienes dependen del subsidio, comparten un dispositivo o necesitan asistencia quedan concentrados entre los abandonos que el promedio trata como una sola categoría.

La primera reacción propone corregir los tres defectos y mantener el lanzamiento. Otra interpretación sostiene que falta capacidad del centro de atención. Una tercera cuestiona el argumento de calidad completo: las pruebas demostraron comportamiento de funciones y componentes en condiciones controladas, pero no adecuación del servicio para poblaciones, escenarios y consecuencias concretas. Los datos disponibles no permiten saber si un abandono fue una elección, una falla técnica, una barrera de accesibilidad o la pérdida de una oportunidad con plazo legal.

El equipo formula escenarios de calidad. Cada escenario nombra población, estímulo, ambiente, respuesta esperada, umbral y consecuencia. El portal debe conservar una solicitud durante una conexión intermitente, explicar errores mediante tecnologías de asistencia, producir una constancia verificable y permitir continuar por otro canal sin perder el turno. La seguridad protege información sensible, pero una autenticación más exigente puede reducir accesibilidad. El desempeño mejora rapidez, aunque una sesión demasiado breve aumenta fallas. La disponibilidad general no compensa una ruta de recuperación inexistente.

La discusión deja de enfrentar “calidad” contra “fecha”. Compara riesgos y compromisos. Mantener el despliegue completo preserva velocidad y visibilidad política, pero expone a una población que tiene pocas alternativas. Suspender todo protege de ciertos daños, aunque posterga beneficios para quienes ya pueden usar el servicio. Una exposición limitada permite aprender si conserva asistencia, reparación y un canal alternativo con capacidad real.

La decisión provisional segmenta el lanzamiento. Se mantienen trámites de baja consecuencia y se detienen los que vencen sin reparación. Las pruebas automatizadas continúan, pero se agregan observación con personas, revisión de accesibilidad, simulación de conexiones degradadas y reconstrucción de episodios. Los resultados se desagregan por canal, dispositivo, asistencia requerida y severidad. El criterio de aprobación no es llegar a cero defectos, sino demostrar que los riesgos principales están comprendidos, limitados y reparables.

El nuevo informe ya no dice “el sistema es de calidad”. Sostiene afirmaciones más precisas: para determinada población y escenario, bajo ciertas condiciones, existe evidencia suficiente para una exposición acotada. También declara lo que todavía no se sabe. Cuando accesibilidad, seguridad, velocidad y capacidad de recuperación entran en tensión, la decisión conserva quién acepta el compromiso, quién observa el daño y qué señal obliga a revisarlo.

N28 recibe contratos verificables y pregunta qué confianza permiten sostener. La respuesta no es acumular pruebas en abstracto, sino construir una arquitectura de evidencia proporcionada al riesgo, capaz de mostrar tanto el desempeño medio como la consecuencia severa que el promedio puede ocultar.

## Hotel Horizonte: el promedio ocultaba a quienes más dependían del servicio

El tablero mensual informa que 194 de 200 ingresos, el 97 por ciento, recibieron habitación en menos de diez minutos y Camila Duarte propone comunicar la mejora. HH-28 utiliza el contrato `asignable` de HH-27 para revisar una muestra intencional de veinte episodios, que incluye los cuatro ingresos de personas que solicitaron una habitación accesible.

Lucía Ferreyra muestra que dos de esos cuatro superaron media hora y uno terminó en reasignación. El cálculo agregado es correcto, pero su denominador y su diseño no sostienen una afirmación de calidad para la población cuya alternativa es más limitada.
...
## Movimiento 1 · Situar calidad en escenarios y riesgos
...
Esa información permite distinguir un defecto del sistema de una extrapolación indebida. Cuando cambia una condición relevante, se reabre el reclamo en lugar de mantener una etiqueta global que perdió relación con el uso.
...
## Movimiento 2 · Convertir reclamos en evidencia suficiente
...
## Movimiento 3 · Resolver tensiones entre atributos y poblaciones
...
La evidencia distingue dominios. WCAG 2.2 se aplica al contenido web y orienta interfaz, navegación, mensajes y compatibilidad con tecnologías de asistencia (W3C, 2023). No prueba que una habitación, un asiento de ducha o el circuito presencial resulten accesibles.

Para esos aspectos, la Convención sobre los Derechos de las Personas con Discapacidad, en particular su artículo 9, exige considerar entorno físico, información, comunicaciones y servicios abiertos al público (Naciones Unidas, 2006). HH-28 combina inspección digital, verificación material del equipamiento, recorrido presencial y participación de personas afectadas sin presentar una fuente como sustituta de las otras.
...
### Instrumento HH-28: argumento de calidad basado en riesgo
...
1. **Promesa.** Formular el resultado que debe conservarse desde la perspectiva de quien usa y recibe el servicio.

2. **Población.** Delimitar grupos, condiciones de acceso y casos cuya exclusión podría ocultar un daño grave.

3. **Escenario.** Describir estímulo, contexto, componente, respuesta y medida esperada en un episodio reproducible.

4. **Atributos.** Seleccionar propiedades decisivas para el escenario y evitar listas universales sin prioridad.

5. **Riesgo.** Relacionar incertidumbre, severidad, población expuesta y reversibilidad de la consecuencia.

6. **Reclamo.** Redactar una afirmación falsable sobre el comportamiento aceptable de la capacidad.

7. **Evidencia.** Combinar prueba técnica, ensayo operacional y observación de consecuencias sobre personas.

8. **Oráculo.** Definir quién y cómo reconocerá una salida válida cuando no exista un único valor correcto.

9. **Umbral.** Fijar el límite de aceptación antes de observar resultados y justificarlo por consecuencia.

10. **Tensión.** Registrar qué atributo, costo o derecho puede deteriorarse al mejorar otro.

11. **Autoridad.** Identificar quién acepta el riesgo residual y quién puede detener o limitar la liberación.

12. **Revisión.** Asociar fecha, nueva evidencia y cambios de población o contexto que invaliden el argumento.
...
La versión completada de HH-28 formula tres escenarios. En ingreso ordinario, ante cuarenta llegadas en diez minutos, el servicio debe entregar o iniciar una reparación explicada dentro del umbral, sin duplicar reserva. En llegada accesible, la condición material específica debe verificarse antes de prometer la habitación y la alternativa no puede exigir un canal impracticable.

Durante una caída de identidad, el turno debe preservar restricciones, emitir una llave limitada mediante autoridad registrada y reconciliar el estado sin duplicar cobro ni asignación. Cada escenario identifica población, carga, fuente, respuesta y medida.
...
El tercero establece una ventana de recuperación y un invariante de reconciliación. Los umbrales se justifican por consecuencia y tamaño de evidencia, no por simetría visual entre filas.

La evidencia enlaza el contrato HH-27, eventos del PMS, bitácora de cerraduras, control material de Housekeeping, observación del turno y relato de la persona afectada. Las pruebas automáticas verifican duplicados y estados; el ensayo operacional comprueba permisos y reparación; la evaluación de accesibilidad cubre pantalla, comunicación, equipamiento y recorrido.

Ricardo conserva la procedencia de cada elemento; Mariela valida condiciones de accesibilidad; Lucía puede detener; Elena acepta riesgo residual sólo para el alcance probado. Una revisión independiente reconstruye cómo cada evidencia sostiene o limita el reclamo.
...
### Caso de transferencia: priorización clínica
...
### Contraejemplo: cobertura como calidad
...
Antes de ejecutarse, la prueba formula un reclamo sobre ingreso accesible, su umbral y el riesgo residual. Luego combina carga concentrada, caída de identidad y una reasignación que sólo puede resolverse manualmente.

Se observan tiempo, corrección, accesibilidad, capacidad de recuperación y trabajo transferido a Recepción. El resultado se desagrega por canal y necesidad; un promedio aceptable no compensa una falla severa sobre la población más expuesta.

N28 aprueba cuando la evidencia permite a Elena decidir un alcance y justificar la tensión aceptada. Si las pruebas sólo demuestran cobertura técnica o cambian el umbral después del resultado, el argumento de calidad queda refutado.

## Errores frecuentes

### Tratar calidad como perfección
...
### Confundir cobertura con confianza
...
### Acumular evidencia irrelevante
...
La prueba se diseña para sostener una decisión concreta, no para producir un número favorable que pueda reutilizarse fuera de contexto.
...
El expediente de calidad debe permitir reconstruir por qué una evidencia habilitó una decisión y no otra. Incluye la versión probada, el escenario, la población, la fuente, el resultado, la incertidumbre y la autoridad que acepta el riesgo. También conserva pruebas que fallaron y explicaciones rivales, porque excluirlas produce una confianza imposible de auditar.

La aceptación puede autorizar exploración, uso asistido o ampliación limitada sin declarar que el sistema posee calidad universal. Cuando cambia el contexto, el reclamo vuelve a ponerse a prueba. Así, N28 convierte la calidad en una relación viva entre consecuencias y evidencia, capaz de orientar inversión y detención sin reducir la discusión a cumplimiento documental o a una cifra agregada.

Cada nueva población obliga a revisar la suficiencia de esa evidencia situada.

## Cinco píldoras para recordar

1. Un promedio favorable no sostiene calidad si oculta a la población con menos alternativas frente a la falla.

2. Toda afirmación de calidad necesita población, escenario, umbral, evidencia y autoridad que acepte el riesgo residual.

3. La severidad puede volver decisivo un error infrecuente que una métrica agregada apenas modifica.

4. Mejorar un atributo puede degradar otro; la decisión profesional declara esa compensación en vez de ocultarla.

5. Más pruebas no equivalen a evidencia suficiente si todas responden una pregunta distinta de la decisión.
...
1. ¿Qué promesa de calidad cambia de significado según la población o el contexto de uso?

2. ¿Qué atributo resulta decisivo para el escenario y cuál podría deteriorarse al mejorarlo?

3. ¿Qué estímulo, contexto, respuesta y medida permitirían reproducir el reclamo?

4. ¿Qué error poco frecuente merece mayor evidencia por su severidad o irreversibilidad?

5. ¿Qué oráculo reconoce una respuesta aceptable cuando existen varias salidas posibles?

6. ¿Quién acepta el riesgo residual y qué resultado obligaría a limitar o detener la liberación?
...
**Len Bass.** Relaciona decisiones de arquitectura con atributos de calidad observables mediante escenarios concretos.

**Nancy Leveson.** Explica seguridad como propiedad sistémica producida por controles, interacciones y restricciones, no sólo por ausencia de fallas de componentes.

**Barry Boehm.** Integra riesgo, costo y decisiones de ingeniería para priorizar evidencia según la consecuencia.

**David Parnas.** Aporta criterios de modularidad y responsabilidad que vuelven localizables los efectos de una falla.

**George Box.** Advierte que toda representación simplifica y que su utilidad depende de límites, propósito y contrastación.

**Amy Edmondson.** Muestra cómo seguridad psicológica y aprendizaje de equipo condicionan la detección y corrección de problemas de calidad.
...
- ISO/IEC (2023). *ISO/IEC 25019:2023 Systems and software engineering, Systems and software Quality Requirements and Evaluation (SQuaRE), Quality-in-use model*. https://www.iso.org/standard/78177.html

- Bass, L., Clements, P. y Kazman, R. (2021). *Software Architecture in Practice*, Fourth Edition. Addison-Wesley.

- Basili, V. R., Caldiera, G. y Rombach, H. D. (1994). “The Goal Question Metric Approach”. En J. J. Marciniak (ed.), *Encyclopedia of Software Engineering*, volumen 1, 528-532. John Wiley & Sons.

- ISO (2018). *ISO 31000:2018 Risk management, Guidelines*. https://www.iso.org/standard/65694.html

- Pascoe, C., Quinn, S. y Scarfone, K. (2024). *The NIST Cybersecurity Framework (CSF) 2.0*. NIST CSWP 29. https://doi.org/10.6028/NIST.CSWP.29
...
- Naciones Unidas (2006). *Convención sobre los Derechos de las Personas con Discapacidad*, artículo 9. https://www.un.org/esa/socdev/enable/documents/tccconvs.pdf

- Beyer, B., Jones, C., Petoff, J. y Murphy, N. R. (2016). *Site Reliability Engineering*. O’Reilly Media. https://sre.google/sre-book/table-of-contents/

- Forsgren, N., Humble, J. y Kim, G. (2018). *Accelerate*. IT Revolution.

- ISO/IEC/IEEE (2021). *ISO/IEC/IEEE 29119-2:2021 Software and systems engineering, Software testing, Part 2: Test processes*. https://www.iso.org/standard/79428.html
