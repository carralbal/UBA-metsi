...
La calidad no es una propiedad absoluta de un sistema ni el resultado de sumar pruebas superadas. Es una afirmación situada sobre adecuación para una población, un escenario y una consecuencia, respaldada por evidencia proporcional al riesgo. Cada reclamo debe declarar atributo, umbral, incertidumbre y compromiso con otros atributos. Un promedio favorable no autoriza una promesa cuando oculta daño severo, exclusión o ausencia de alternativa. La decisión profesional consiste en limitar exposición, combinar fuentes de evidencia y conservar capacidad de recuperación hasta demostrar que el servicio puede sostener su propósito bajo las condiciones que más importan, no sólo bajo las más fáciles de medir.
